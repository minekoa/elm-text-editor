...
var _minekoa$elm_text_editor$TextEditor_StringExtra$previosWordPosProc = F3(
	function (fwd_char_t, reversed_str, n) {
		...
		while (true) {
			...
			if (_p9.ctor === '::') {
				...
				return _elm_lang$core$Native_Utils.eq(fwd_char_t, _minekoa$elm_text_editor$TextEditor_StringExtra$SpaceChar) ? _elm_lang$core$Maybe$Nothing : _elm_lang$core$Maybe$Just(n);
			}
		}
	});
var _minekoa$elm_text_editor$TextEditor_StringExtra$previosWordPos = F2(
	function (line, column) {
		var forward_chars = A2(
			_elm_lang$core$List$take,
			column,
			_elm_lang$core$String$toList(line));
		return A3(
			_minekoa$elm_text_editor$TextEditor_StringExtra$previosWordPosProc,
			_minekoa$elm_text_editor$TextEditor_StringExtra$chartype(
				A2(
					_elm_lang$core$Maybe$withDefault,
					_elm_lang$core$Native_Utils.chr('\n'),
					_elm_lang$core$List$head(
						_elm_lang$core$List$reverse(forward_chars)))),
			_elm_lang$core$List$reverse(forward_chars),
			column);
	});
...
var _minekoa$elm_text_editor$TextEditor_Buffer_ops = _minekoa$elm_text_editor$TextEditor_Buffer_ops || {};
_minekoa$elm_text_editor$TextEditor_Buffer_ops['!!'] = F2(
	function (lst, n) {
...
var _minekoa$elm_text_editor$TextEditor_Buffer$movePreviosLineProc = function (model) {
	...
	return function (c) {
		...
		A2(
			...
			A2(
				...
				A2(_minekoa$elm_text_editor$TextEditor_Buffer_ops['!!'], model.contents, cur.row - 1))));
};
var _minekoa$elm_text_editor$TextEditor_Buffer$moveNextLineProc = function (model) {
	var cur = model.cursor;
	return function (c) {
		return _elm_lang$core$Native_Utils.update(
			model,
...
var _minekoa$elm_text_editor$TextEditor_Buffer$line = F2(
	function (n, buf) {
		return A2(_minekoa$elm_text_editor$TextEditor_Buffer_ops['!!'], buf.contents, n);
	});
var _minekoa$elm_text_editor$TextEditor_Buffer$currentLine = function (buf) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		'',
		A2(_minekoa$elm_text_editor$TextEditor_Buffer$line, buf.cursor.row, buf));
};
var _minekoa$elm_text_editor$TextEditor_Buffer$isPreviosPos = F2(
	function (p, q) {
		return _elm_lang$core$Native_Utils.eq(p.row, q.row) ? (_elm_lang$core$Native_Utils.cmp(p.column, q.column) < 0) : (_elm_lang$core$Native_Utils.cmp(p.row, q.row) < 0);
	});
var _minekoa$elm_text_editor$TextEditor_Buffer$readRange = F2(
	function (sel, model) {
		...
		var lcnt = epos.row - bpos.row;
		var _p4 = lcnt;
		if (_p4 === 0) {
			var l = A2(
				_elm_lang$core$Maybe$withDefault,
				'',
				A2(_minekoa$elm_text_editor$TextEditor_Buffer_ops['!!'], model.contents, bpos.row));
			return A2(
				_elm_lang$core$String$left,
				epos.column - bpos.column,
				A2(_elm_lang$core$String$dropLeft, bpos.column, l));
		} else {
			var ls = A2(
				_elm_lang$core$List$take,
				lcnt - 1,
				A2(_elm_lang$core$List$drop, bpos.row + 1, model.contents));
			var el = A2(
				_elm_lang$core$String$left,
				epos.column,
				A2(
					_elm_lang$core$Maybe$withDefault,
					'',
					A2(_minekoa$elm_text_editor$TextEditor_Buffer_ops['!!'], model.contents, epos.row)));
			var bl = A2(
...
var _minekoa$elm_text_editor$TextEditor_Buffer$delete_range_proc = F2(
	function (sel, model) {
		...
		var _p5 = lcnt;
		if (_p5 === 0) {
			var nls = A2(_elm_lang$core$List$drop, epos.row + 1, model.contents);
			var pls = A2(_elm_lang$core$List$take, bpos.row, model.contents);
			var ln = A2(
				_elm_lang$core$Maybe$withDefault,
				'',
				A2(_minekoa$elm_text_editor$TextEditor_Buffer_ops['!!'], model.contents, bpos.row));
			var current = A2(
				_elm_lang$core$Basics_ops['++'],
				A2(_elm_lang$core$String$left, bpos.column, ln),
				A2(_elm_lang$core$String$dropLeft, epos.column, ln));
			return _elm_lang$core$Native_Utils.update(
				model,
				{
					contents: A2(
...
var _minekoa$elm_text_editor$TextEditor_Buffer$position_fromTuple = function (_p6) {
	var _p7 = _p6;
	return {row: _p7._0, column: _p7._1};
};
var _minekoa$elm_text_editor$TextEditor_Buffer$position_toTuple = function (pos) {
	return {ctor: '_Tuple2', _0: pos.row, _1: pos.column};
};
var _minekoa$elm_text_editor$TextEditor_Buffer$Position = F2(
	function (a, b) {
		return {row: a, column: b};
	});
var _minekoa$elm_text_editor$TextEditor_Buffer_ops = _minekoa$elm_text_editor$TextEditor_Buffer_ops || {};
_minekoa$elm_text_editor$TextEditor_Buffer_ops['@'] = _minekoa$elm_text_editor$TextEditor_Buffer$Position;
var _minekoa$elm_text_editor$TextEditor_Buffer$updateMarkPos_byDelete = F3(
	function (bgn_pos, s, marked_pos) {
		var count_last_line_char = function (_p8) {
				...
				A2(
					...
					_elm_lang$core$List$head(
						_elm_lang$core$List$reverse(
							_elm_lang$core$String$lines(_p8)))));
		};
		var deleted_lastline_char_cnt = count_last_line_char(s);
		var count_lf = function (_p9) {
			return A3(
		...
		var _p10 = {
			ctor: '_Tuple2',
			_0: bgn_pos.row + deleted_lf_cnt,
			_1: _elm_lang$core$Native_Utils.eq(deleted_lf_cnt, 0) ? (bgn_pos.column + deleted_lastline_char_cnt) : deleted_lastline_char_cnt
		};
		var end_row = _p10._0;
		var end_col = _p10._1;
		return (_elm_lang$core$Native_Utils.cmp(end_row, marked_pos.row) < 0) ? A2(_minekoa$elm_text_editor$TextEditor_Buffer_ops['@'], marked_pos.row - deleted_lf_cnt, marked_pos.column) : ((_elm_lang$core$Native_Utils.eq(marked_pos.row, end_row) && (_elm_lang$core$Native_Utils.cmp(end_col, marked_pos.column) < 0)) ? ((!_elm_lang$core$Native_Utils.eq(end_row, bgn_pos.row)) ? A2(_minekoa$elm_text_editor$TextEditor_Buffer_ops['@'], marked_pos.row - deleted_lf_cnt, marked_pos.column + bgn_pos.column) : A2(_minekoa$elm_text_editor$TextEditor_Buffer_ops['@'], marked_pos.row, marked_pos.column - deleted_lastline_char_cnt)) : ((((_elm_lang$core$Native_Utils.cmp(bgn_pos.row, marked_pos.row) < 0) || (_elm_lang$core$Native_Utils.eq(bgn_pos.row, marked_pos.row) && (_elm_lang$core$Native_Utils.cmp(bgn_pos.column, marked_pos.column) < 1))) && ((_elm_lang$core$Native_Utils.cmp(marked_pos.row, end_row) < 0) || (_elm_lang$core$Native_Utils.eq(end_row, marked_pos.row) && (_elm_lang$core$Native_Utils.cmp(marked_pos.column, end_col) < 1)))) ? bgn_pos : marked_pos));
	});
var _minekoa$elm_text_editor$TextEditor_Buffer$updateMark = F2(
	function (cmd, model) {
		...
		if (_p11.ctor === 'Just') {
			var _p18 = _p11._0;
			var count_last_line_char = function (_p12) {
				return _elm_lang$core$String$length(
					A2(
						_elm_lang$core$Maybe$withDefault,
						'',
						_elm_lang$core$List$head(
							_elm_lang$core$List$reverse(
								_elm_lang$core$String$lines(_p12)))));
			};
			var count_lf = function (_p13) {
				return A3(
					_elm_lang$core$Basics$flip,
					F2(
						function (x, y) {
					...
					1,
					_elm_lang$core$List$length(
						_elm_lang$core$String$lines(_p13)));
			};
			var _p14 = cmd;
			switch (_p14.ctor) {
				case 'Cmd_Insert':
					...
					var _p16 = _p14._0;
					var _p15 = _p14._1;
					if (_elm_lang$core$Native_Utils.cmp(_p18.pos.row, _p16.row) > 0) {
						return _elm_lang$core$Native_Utils.update(
							model,
							{
								mark: _elm_lang$core$Maybe$Just(
									_elm_lang$core$Native_Utils.update(
										_p18,
										{
											pos: A2(_minekoa$elm_text_editor$TextEditor_Buffer_ops['@'], (_p18.pos.row + _p15.row) - _p16.row, _p18.pos.column)
										}))
							});
					} else {
						if (_elm_lang$core$Native_Utils.eq(_p18.pos.row, _p16.row) && (_elm_lang$core$Native_Utils.cmp(_p16.column, _p18.pos.column) < 1)) {
							var add_line_cnt = count_lf(_p17);
							var new_col = _elm_lang$core$Native_Utils.eq(add_line_cnt, 0) ? (_p18.pos.column + (_p15.column - _p16.column)) : (count_last_line_char(_p17) + (_p18.pos.column - _p16.column));
							return _elm_lang$core$Native_Utils.update(
								model,
								{
									mark: _elm_lang$core$Maybe$Just(
										_elm_lang$core$Native_Utils.update(
											_p18,
											{
												pos: A2(_minekoa$elm_text_editor$TextEditor_Buffer_ops['@'], _p18.pos.row + add_line_cnt, new_col)
											}))
								});
						} else {
							return model;
						...
						model,
						{
							mark: _elm_lang$core$Maybe$Just(
								_elm_lang$core$Native_Utils.update(
									_p18,
									{
										pos: A3(_minekoa$elm_text_editor$TextEditor_Buffer$updateMarkPos_byDelete, _p14._1, _p14._2, _p18.pos)
									}))
						});
				default:
					return _elm_lang$core$Native_Utils.update(
						model,
						{
							mark: _elm_lang$core$Maybe$Just(
								_elm_lang$core$Native_Utils.update(
									_p18,
									{
										pos: A3(_minekoa$elm_text_editor$TextEditor_Buffer$updateMarkPos_byDelete, _p14._0, _p14._2, _p18.pos)
									}))
						});
			}
		} else {
...
var _minekoa$elm_text_editor$TextEditor_Buffer$defaultCursor = function (contents) {
	...
	return A2(
		_minekoa$elm_text_editor$TextEditor_Buffer$Position,
	...
	return function (c) {
		...
		A2(
			...
			A2(
				...
				A2(_minekoa$elm_text_editor$TextEditor_Buffer_ops['!!'], model.contents, cur.row))));
};
		...
		while (true) {
			...
			if (_p21.ctor === 'Just') {
				return A2(
					...
					A2(_minekoa$elm_text_editor$TextEditor_Buffer$Position, cur.row, _p21._0),
					model);
			} else {
						...
						A2(
							...
							_elm_lang$core$String$length(
								A2(
									_elm_lang$core$Maybe$withDefault,
									'',
									A2(_minekoa$elm_text_editor$TextEditor_Buffer_ops['!!'], model.contents, last_row)))),
						model);
				} else {
					var _v12 = A2(_minekoa$elm_text_editor$TextEditor_Buffer$Position, cur.row + 1, 0),
						_v13 = model;
					cur = _v12;
					model = _v13;
...
var _minekoa$elm_text_editor$TextEditor_Buffer$movePreviosWordProc = F2(
	function (cur, model) {
		movePreviosWordProc:
		while (true) {
			var col = A2(
				_minekoa$elm_text_editor$TextEditor_StringExtra$previosWordPos,
				A2(
					_elm_lang$core$Maybe$withDefault,
					'',
					A2(_minekoa$elm_text_editor$TextEditor_Buffer_ops['!!'], model.contents, cur.row)),
			...
			if (_p22.ctor === 'Just') {
				return A2(
					_minekoa$elm_text_editor$TextEditor_Buffer$moveAtProc,
					A2(_minekoa$elm_text_editor$TextEditor_Buffer$Position, cur.row, _p22._0),
					model);
			} else {
				if (_elm_lang$core$Native_Utils.cmp(cur.row - 1, 0) < 0) {
					return A2(
						_minekoa$elm_text_editor$TextEditor_Buffer$moveAtProc,
					...
					cur = _v15;
					model = _v16;
					continue movePreviosWordProc;
				}
			}
		}
	});
var _minekoa$elm_text_editor$TextEditor_Buffer$insert_proc = F3(
	function (pos, text, model) {
		var car = function (_p23) {
			return A2(
				_elm_lang$core$Maybe$withDefault,
				'',
		...
		var _p24 = _minekoa$elm_text_editor$TextEditor_Buffer$position_toTuple(pos);
		var row = _p24._0;
		var col = _p24._1;
		var prows = A2(_elm_lang$core$List$take, row, contents);
		var crow = A2(
			_elm_lang$core$Maybe$withDefault,
			'',
			A2(_minekoa$elm_text_editor$TextEditor_Buffer_ops['!!'], model.contents, row));
		var nrows = A2(_elm_lang$core$List$drop, row + 1, contents);
		var left = A2(_elm_lang$core$String$left, col, crow);
		var right = A2(_elm_lang$core$String$dropLeft, col, crow);
		var _p25 = _elm_lang$core$List$length(texts);
		switch (_p25) {
			case 0:
				return model;
			case 1:
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						...
						cursor: A2(
							_minekoa$elm_text_editor$TextEditor_Buffer$Position,
							row,
							col + _elm_lang$core$String$length(text))
					});
			case 2:
				var lst_ln = car(
			...
			default:
				var _p26 = _p25;
				var lst_ln = car(
					A2(_elm_lang$core$List$drop, _p26 - 1, texts));
				var fst_ln = car(texts);
				return _elm_lang$core$Native_Utils.update(
					model,
					{
							...
							A2(
								...
								A2(
									...
									A2(
										_elm_lang$core$List$drop,
										1,
										A2(_elm_lang$core$List$take, _p26 - 1, texts)),
									A2(
										_elm_lang$core$Basics_ops['++'],
										{
											ctor: '::',
...
var _minekoa$elm_text_editor$TextEditor_Buffer$undo_backspace_proc = F4(
	function (bf_pos, af_pos, str, model) {
		return A3(_minekoa$elm_text_editor$TextEditor_Buffer$insert_proc, af_pos, str, model);
	});
var _minekoa$elm_text_editor$TextEditor_Buffer$undo_delete_proc = F4(
	function (bf_pos, af_pos, str, model) {
		return function (m) {
			...
			A3(_minekoa$elm_text_editor$TextEditor_Buffer$insert_proc, bf_pos, str, model));
	});
var _minekoa$elm_text_editor$TextEditor_Buffer$backspace_proc = F2(
	function (pos, model) {
		var _p27 = _minekoa$elm_text_editor$TextEditor_Buffer$position_toTuple(pos);
		if (_p27._1 === 0) {
			if (_p27._0 === 0) {
				...
				var n_col = _elm_lang$core$String$length(
					A2(
						...
						'',
						_elm_lang$core$List$head(
							A2(_elm_lang$core$List$drop, _p28 - 1, model.contents))));
				var nrows = A2(_elm_lang$core$List$drop, _p28 + 1, model.contents);
				var crow = _elm_lang$core$String$concat(
					A2(
						_elm_lang$core$List$take,
						2,
						A2(_elm_lang$core$List$drop, _p28 - 1, model.contents)));
				var prows = A2(_elm_lang$core$List$take, _p28 - 1, model.contents);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							...
							cursor: A2(_minekoa$elm_text_editor$TextEditor_Buffer$Position, _p28 - 1, n_col)
						}),
			...
			var _p30 = _p27._0;
			var _p29 = _p27._1;
			var nrows = A2(_elm_lang$core$List$drop, _p30 + 1, model.contents);
			var crow = A2(
				_elm_lang$core$Maybe$withDefault,
				'',
				A2(_minekoa$elm_text_editor$TextEditor_Buffer_ops['!!'], model.contents, _p30));
			var left = A2(_elm_lang$core$String$left, _p29 - 1, crow);
			var right = A2(_elm_lang$core$String$dropLeft, _p29, crow);
			var prows = A2(_elm_lang$core$List$take, _p30, model.contents);
			return {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{
						...
						cursor: A2(_minekoa$elm_text_editor$TextEditor_Buffer$Position, _p30, _p29 - 1)
					}),
				_1: _elm_lang$core$Maybe$Just(
					A2(
						_elm_lang$core$String$left,
						1,
						A2(_elm_lang$core$String$dropLeft, _p29 - 1, crow)))
			};
		}
	});
var _minekoa$elm_text_editor$TextEditor_Buffer$delete_proc = F2(
	function (pos, model) {
		...
		var _p31 = _minekoa$elm_text_editor$TextEditor_Buffer$position_toTuple(pos);
		var row = _p31._0;
		var col = _p31._1;
		var ln = A2(
			_elm_lang$core$Maybe$withDefault,
		...
		var _p32 = {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Native_Utils.eq(row, max_row),
			_1: _elm_lang$core$Native_Utils.cmp(col, max_col) > 0
		};
		if (_p32._1 === false) {
			var current = A2(
				_elm_lang$core$Basics_ops['++'],
				A2(_elm_lang$core$String$left, col, ln),
				A2(_elm_lang$core$String$dropLeft, col + 1, ln));
			var nrows = A2(_elm_lang$core$List$drop, row + 1, model.contents);
			var prows = A2(_elm_lang$core$List$take, row, model.contents);
			return {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{
						...
						cursor: A2(_minekoa$elm_text_editor$TextEditor_Buffer$Position, row, col)
					}),
				_1: _elm_lang$core$Maybe$Just(
					A2(
						_elm_lang$core$String$left,
						1,
						A2(_elm_lang$core$String$dropLeft, col, ln)))
			};
		} else {
			if (_p32._0 === true) {
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Maybe$Nothing};
			} else {
				var nrows = A2(_elm_lang$core$List$drop, row + 2, model.contents);
				var nxt = A2(
					_elm_lang$core$Maybe$withDefault,
					'',
					A2(_minekoa$elm_text_editor$TextEditor_Buffer_ops['!!'], model.contents, row + 1));
...
var _minekoa$elm_text_editor$TextEditor_Buffer$makeRange = F2(
	function (_p34, _p33) {
		var _p35 = _p34;
		var _p36 = _p33;
		return A2(
			_minekoa$elm_text_editor$TextEditor_Buffer$Range,
			A2(_minekoa$elm_text_editor$TextEditor_Buffer$Position, _p35._0, _p35._1),
			A2(_minekoa$elm_text_editor$TextEditor_Buffer$Position, _p36._0, _p36._1));
	});
var _minekoa$elm_text_editor$TextEditor_Buffer$markSet = function (model) {
	var pos = model.cursor;
				...
				return _elm_lang$core$Native_Utils.update(
					m,
					{
						selection: A2(
							...
							function (s) {
								return _elm_lang$core$Maybe$Just(
									A2(_minekoa$elm_text_editor$TextEditor_Buffer$Range, s.begin, m.cursor));
							},
							m.selection)
					});
			}(
					...
					_elm_lang$core$Native_Utils.update(
						m,
						{
							selection: _elm_lang$core$Maybe$Just(
								A2(
									_elm_lang$core$Maybe$withDefault,
									A2(_minekoa$elm_text_editor$TextEditor_Buffer$Range, m.cursor, m.cursor),
									m.selection))
						})));
		}(model);
	});
var _minekoa$elm_text_editor$TextEditor_Buffer$moveForward = function (model) {
	var _p37 = _minekoa$elm_text_editor$TextEditor_Buffer$isMarkActive(model);
	if (_p37 === true) {
...
var _minekoa$elm_text_editor$TextEditor_Buffer$moveBackward = function (model) {
	var _p38 = _minekoa$elm_text_editor$TextEditor_Buffer$isMarkActive(model);
	if (_p38 === true) {
...
var _minekoa$elm_text_editor$TextEditor_Buffer$movePreviosLine = function (model) {
	var _p39 = _minekoa$elm_text_editor$TextEditor_Buffer$isMarkActive(model);
	if (_p39 === true) {
		return A2(_minekoa$elm_text_editor$TextEditor_Buffer$selectWithMove, _minekoa$elm_text_editor$TextEditor_Buffer$movePreviosLineProc, model);
	} else {
		return _minekoa$elm_text_editor$TextEditor_Buffer$selectionClear(
			_minekoa$elm_text_editor$TextEditor_Buffer$movePreviosLineProc(model));
	}
};
var _minekoa$elm_text_editor$TextEditor_Buffer$moveNextLine = function (model) {
	var _p40 = _minekoa$elm_text_editor$TextEditor_Buffer$isMarkActive(model);
	if (_p40 === true) {
		return A2(_minekoa$elm_text_editor$TextEditor_Buffer$selectWithMove, _minekoa$elm_text_editor$TextEditor_Buffer$moveNextLineProc, model);
	} else {
		return _minekoa$elm_text_editor$TextEditor_Buffer$selectionClear(
			_minekoa$elm_text_editor$TextEditor_Buffer$moveNextLineProc(model));
	}
};
var _minekoa$elm_text_editor$TextEditor_Buffer$moveAt = F2(
	function (pos, model) {
		var _p41 = _minekoa$elm_text_editor$TextEditor_Buffer$isMarkActive(model);
		if (_p41 === true) {
			return A2(
			...
			return _minekoa$elm_text_editor$TextEditor_Buffer$selectionClear(
				A2(_minekoa$elm_text_editor$TextEditor_Buffer$moveAtProc, pos, model));
		}
	});
...
var _minekoa$elm_text_editor$TextEditor_Buffer$moveNextWord = function (model) {
	var _p43 = _minekoa$elm_text_editor$TextEditor_Buffer$isMarkActive(model);
	if (_p43 === true) {
		return A2(
			_minekoa$elm_text_editor$TextEditor_Buffer$selectWithMove,
...
var _minekoa$elm_text_editor$TextEditor_Buffer$movePreviosWord = function (model) {
	var _p44 = _minekoa$elm_text_editor$TextEditor_Buffer$isMarkActive(model);
	if (_p44 === true) {
		return A2(
			_minekoa$elm_text_editor$TextEditor_Buffer$selectWithMove,
			_minekoa$elm_text_editor$TextEditor_Buffer$movePreviosWordProc(model.cursor),
			model);
	} else {
		return _minekoa$elm_text_editor$TextEditor_Buffer$selectionClear(
			A2(_minekoa$elm_text_editor$TextEditor_Buffer$movePreviosWordProc, model.cursor, model));
	}
};
var _minekoa$elm_text_editor$TextEditor_Buffer$selectBackward = function (_p45) {
	return A2(
		_minekoa$elm_text_editor$TextEditor_Buffer$selectWithMove,
...
var _minekoa$elm_text_editor$TextEditor_Buffer$selectForward = function (_p46) {
	return A2(
		_minekoa$elm_text_editor$TextEditor_Buffer$selectWithMove,
...
var _minekoa$elm_text_editor$TextEditor_Buffer$selectPreviosLine = function (_p47) {
	return A2(
		_minekoa$elm_text_editor$TextEditor_Buffer$selectWithMove,
		_minekoa$elm_text_editor$TextEditor_Buffer$movePreviosLineProc,
		function (m) {
			return _minekoa$elm_text_editor$TextEditor_Buffer$isMarkActive(m) ? _minekoa$elm_text_editor$TextEditor_Buffer$markClear(m) : m;
		}(_p47));
};
var _minekoa$elm_text_editor$TextEditor_Buffer$selectNextLine = function (_p48) {
	return A2(
		_minekoa$elm_text_editor$TextEditor_Buffer$selectWithMove,
		_minekoa$elm_text_editor$TextEditor_Buffer$moveNextLineProc,
		function (m) {
			return _minekoa$elm_text_editor$TextEditor_Buffer$isMarkActive(m) ? _minekoa$elm_text_editor$TextEditor_Buffer$markClear(m) : m;
		}(_p48));
};
var _minekoa$elm_text_editor$TextEditor_Buffer$selectPreviosWord = function (_p49) {
	return A2(
		_minekoa$elm_text_editor$TextEditor_Buffer$selectWithMove,
		function (m) {
			return A2(_minekoa$elm_text_editor$TextEditor_Buffer$movePreviosWordProc, m.cursor, m);
		},
		function (m) {
			return _minekoa$elm_text_editor$TextEditor_Buffer$isMarkActive(m) ? _minekoa$elm_text_editor$TextEditor_Buffer$markClear(m) : m;
		}(_p49));
};
var _minekoa$elm_text_editor$TextEditor_Buffer$selectNextWord = function (_p50) {
	return A2(
		_minekoa$elm_text_editor$TextEditor_Buffer$selectWithMove,
		function (m) {
			return A2(_minekoa$elm_text_editor$TextEditor_Buffer$moveNextWordProc, m.cursor, m);
		},
		function (m) {
			return _minekoa$elm_text_editor$TextEditor_Buffer$isMarkActive(m) ? _minekoa$elm_text_editor$TextEditor_Buffer$markClear(m) : m;
		}(_p50));
...
var _minekoa$elm_text_editor$TextEditor_Buffer$undo_insert_proc = F4(
	function (bf_pos, af_pos, str, model) {
		return A2(
			...
			A2(_minekoa$elm_text_editor$TextEditor_Buffer$Range, bf_pos, af_pos),
			model);
	});
var _minekoa$elm_text_editor$TextEditor_Buffer$undo = function (model) {
	var _p52 = _elm_lang$core$List$head(model.history);
				...
				switch (_p53.ctor) {
					case 'Cmd_Insert':
						return function (m) {
							...
							A4(_minekoa$elm_text_editor$TextEditor_Buffer$undo_insert_proc, _p53._0, _p53._1, _p53._2, model));
					case 'Cmd_Backspace':
						return function (m) {
							return _elm_lang$core$Native_Utils.update(
								m,
							...
							A4(_minekoa$elm_text_editor$TextEditor_Buffer$undo_backspace_proc, _p53._0, _p53._1, _p53._2, model));
					default:
						return function (m) {
							return _elm_lang$core$Native_Utils.update(
								m,
							...
							A4(_minekoa$elm_text_editor$TextEditor_Buffer$undo_delete_proc, _p53._0, _p53._1, _p53._2, model));
				}
			}());
	}
};
...
var _minekoa$elm_text_editor$TextEditor_Buffer$appendHistory = F2(
	function (cmd, model) {
		...
		_v32_3:
		do {
			if (_p54._1.ctor === 'Just') {
				switch (_p54._0.ctor) {
					case 'Cmd_Insert':
						if (_p54._1._0.ctor === 'Cmd_Insert') {
							var _p56 = _p54._1._0._0;
							var _p55 = _p54._0._0;
							return (_elm_lang$core$Native_Utils.eq(_p55.row, _p56.row) && _elm_lang$core$Native_Utils.eq(_p55.column, _p54._1._0._1.column)) ? _elm_lang$core$Native_Utils.update(
								model,
								{
									history: {
										ctor: '::',
										_0: A4(
											...
											_p56,
											_p54._0._1,
											A2(_elm_lang$core$Basics_ops['++'], _p54._1._0._2, _p54._0._2),
											_p54._1._0._3),
					...
					case 'Cmd_Backspace':
						if (_p54._1._0.ctor === 'Cmd_Backspace') {
							var _p58 = _p54._1._0._0;
							var _p57 = _p54._0._0;
							return (_elm_lang$core$Native_Utils.eq(_p57.row, _p58.row) && _elm_lang$core$Native_Utils.eq(_p57.column, _p54._1._0._1.column)) ? _elm_lang$core$Native_Utils.update(
								model,
								{
									history: {
										ctor: '::',
										_0: A4(
											...
											_p58,
											_p54._0._1,
											A2(_elm_lang$core$Basics_ops['++'], _p54._0._2, _p54._1._0._2),
											_p54._1._0._3),
										_1: A2(_elm_lang$core$List$drop, 1, model.history)
									}
								}) : _elm_lang$core$Native_Utils.update(
					...
					default:
						if (_p54._1._0.ctor === 'Cmd_Delete') {
							var _p60 = _p54._1._0._0;
							var _p59 = _p54._0._0;
							return (_elm_lang$core$Native_Utils.eq(_p59.row, _p60.row) && _elm_lang$core$Native_Utils.eq(_p59.column, _p60.column)) ? _elm_lang$core$Native_Utils.update(
								model,
								{
									history: {
										ctor: '::',
...
var _minekoa$elm_text_editor$TextEditor_Buffer$backspaceAt = F2(
	function (pos, model) {
		var _p61 = A2(_minekoa$elm_text_editor$TextEditor_Buffer$backspace_proc, pos, model);
		var m = _p61._0;
		var deleted = _p61._1;
		var _p62 = deleted;
		if (_p62.ctor === 'Nothing') {
			...
			return function (m) {
				var edtcmd = A4(_minekoa$elm_text_editor$TextEditor_Buffer$Cmd_Backspace, pos, m.cursor, _p62._0, m.mark);
				return A2(
...
var _minekoa$elm_text_editor$TextEditor_Buffer$deleteAt = F2(
	function (pos, model) {
		var _p63 = A2(_minekoa$elm_text_editor$TextEditor_Buffer$delete_proc, pos, model);
		var m = _p63._0;
		var deleted = _p63._1;
		var _p64 = deleted;
		if (_p64.ctor === 'Nothing') {
			...
			return function (m) {
				var edtcmd = A4(_minekoa$elm_text_editor$TextEditor_Buffer$Cmd_Delete, pos, m.cursor, _p64._0, m.mark);
				return A2(
					_minekoa$elm_text_editor$TextEditor_Buffer$updateMark,
					edtcmd,
					A2(_minekoa$elm_text_editor$TextEditor_Buffer$appendHistory, edtcmd, m));
...
var _minekoa$elm_text_editor$TextEditor_Buffer$deleteRange = F2(
	function (range, model) {
		...
		if (_p65 === '') {
			...
			return function (m) {
				var edtcmd = A4(_minekoa$elm_text_editor$TextEditor_Buffer$Cmd_Delete, head_pos, m.cursor, deleted, m.mark);
				return A2(
					_minekoa$elm_text_editor$TextEditor_Buffer$updateMark,
					edtcmd,
					A2(_minekoa$elm_text_editor$TextEditor_Buffer$appendHistory, edtcmd, m));
...
var _minekoa$elm_text_editor$TextEditor_Buffer$backspace = function (model) {
	...
	if (_p66.ctor === 'Nothing') {
		return A2(_minekoa$elm_text_editor$TextEditor_Buffer$backspaceAt, model.cursor, model);
	} else {
		return _minekoa$elm_text_editor$TextEditor_Buffer$selectionClear(
...
var _minekoa$elm_text_editor$TextEditor_Buffer$delete = function (model) {
	...
	if (_p67.ctor === 'Nothing') {
		return A2(_minekoa$elm_text_editor$TextEditor_Buffer$deleteAt, model.cursor, model);
	} else {
		return _minekoa$elm_text_editor$TextEditor_Buffer$selectionClear(
			A2(_minekoa$elm_text_editor$TextEditor_Buffer$deleteRange, _p67._0, model));
	}
};
...
var _minekoa$elm_text_editor$TextEditor_Buffer$insertAt = F3(
	function (pos, text, model) {
		return function (m) {
			var edtcmd = A4(_minekoa$elm_text_editor$TextEditor_Buffer$Cmd_Insert, pos, m.cursor, text, m.mark);
			return A2(
				_minekoa$elm_text_editor$TextEditor_Buffer$updateMark,
				edtcmd,
				A2(_minekoa$elm_text_editor$TextEditor_Buffer$appendHistory, edtcmd, m));
		}(
			A3(_minekoa$elm_text_editor$TextEditor_Buffer$insert_proc, pos, text, model));
	});
var _minekoa$elm_text_editor$TextEditor_Buffer$insert = F2(
	function (text, model) {
		var _p69 = model.selection;
		if (_p69.ctor === 'Nothing') {
			return A3(_minekoa$elm_text_editor$TextEditor_Buffer$insertAt, model.cursor, text, model);
		} else {
			return function (m) {
				return A3(_minekoa$elm_text_editor$TextEditor_Buffer$insertAt, m.cursor, text, m);
			}(
				_minekoa$elm_text_editor$TextEditor_Buffer$selectionClear(
					A2(_minekoa$elm_text_editor$TextEditor_Buffer$deleteRange, _p69._0, model)));
		}
	});

var _minekoa$elm_text_editor$TextEditor_Option$jsonEncode = function (opt) {
	return _elm_lang$core$Json_Encode$object(
		{
			...
			_0: {
				ctor: '_Tuple2',
				_0: 'tabOrder',
				_1: _elm_lang$core$Json_Encode$int(opt.tabOrder)
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'indentTabsMode',
					_1: _elm_lang$core$Json_Encode$bool(opt.indentTabsMode)
				},
				_1: {
					ctor: '::',
					_0: {
						...
						_1: _elm_lang$core$Json_Encode$bool(opt.showControlCharactor)
					},
					_1: {ctor: '[]'}
				}
			}
...
var _minekoa$elm_text_editor$TextEditor_Option$editorLikeOptions = {tabOrder: 4, indentTabsMode: false, showControlCharactor: true};
var _minekoa$elm_text_editor$TextEditor_Option$notepadLikeOptions = {tabOrder: 8, indentTabsMode: true, showControlCharactor: false};
var _minekoa$elm_text_editor$TextEditor_Option$Option = F3(
	function (a, b, c) {
		return {tabOrder: a, indentTabsMode: b, showControlCharactor: c};
	});
var _minekoa$elm_text_editor$TextEditor_Option$jsonDecode = A4(
...
var _minekoa$elm_text_editor$TextEditor_Core$clearEventRequest = function (model) {
	return _elm_lang$core$Native_Utils.update(
		model,
		{eventRequest: _elm_lang$core$Maybe$Nothing});
};
var _minekoa$elm_text_editor$TextEditor_Core$setEventRequest = F2(
	function (evnt, model) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{
...
var _minekoa$elm_text_editor$TextEditor_Core$EventInput = function (a) {
	return {ctor: 'EventInput', _0: a};
};
...
var _minekoa$elm_text_editor$TextEditor_Core$init = F3(
	function (id, opts, text) {
		return {
			ctor: '_Tuple2',
			_0: _minekoa$elm_text_editor$TextEditor_Core$Model(id)(
				_minekoa$elm_text_editor$TextEditor_Buffer$init(text))(opts)('')(_elm_lang$core$Maybe$Nothing)(_elm_lang$core$Maybe$Nothing)(_elm_lang$core$Maybe$Nothing)(false)(_minekoa$elm_text_editor$TextEditor_Core$BlinkBlocked)(1),
	...
	function (data, model) {
		return function (m) {
			return _minekoa$elm_text_editor$TextEditor_Core$withEnsureVisibleCmd(
				A2(
					_minekoa$elm_text_editor$TextEditor_Core$setEventRequest,
					_minekoa$elm_text_editor$TextEditor_Core$EventInput(m.buffer.contents),
					m));
		}(
...
var _minekoa$elm_text_editor$TextEditor_Core_Commands$nop = function (model) {
	return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
};
var _minekoa$elm_text_editor$TextEditor_Core_Commands$unindent = function (model) {
	...
	var curline = _minekoa$elm_text_editor$TextEditor_Buffer$currentLine(model.buffer);
	...
	var _p0 = {ctor: '_Tuple2', _0: model.buffer.cursor.row, _1: model.buffer.cursor.column};
	var row = _p0._0;
	var col = _p0._1;
	var prevline = A2(
		_elm_lang$core$Maybe$withDefault,
		'',
		A2(_minekoa$elm_text_editor$TextEditor_Buffer$line, row - 1, model.buffer));
						...
						if (_elm_lang$core$Native_Utils.eq(prev_level, cur_level)) {
							...
							return A2(
								...
								A3(
									...
									A2(_minekoa$elm_text_editor$TextEditor_Buffer$Position, row, 0),
									new_indent,
									A2(
										...
										A2(
											...
											A2(
												_minekoa$elm_text_editor$TextEditor_Buffer$Position,
												row,
												_elm_lang$core$String$length(cur_indent))),
										model.buffer)));
						} else {
							return A2(
								_minekoa$elm_text_editor$TextEditor_Buffer$moveAt,
...
var _minekoa$elm_text_editor$TextEditor_Core_Commands$indent = function (model) {
	...
	var cur_indent = _minekoa$elm_text_editor$TextEditor_StringExtra$indentString(curline);
	var cur_level = A2(_minekoa$elm_text_editor$TextEditor_StringExtra$indentLevel, model.option.tabOrder, cur_indent);
	var _p1 = {ctor: '_Tuple2', _0: model.buffer.cursor.row, _1: model.buffer.cursor.column};
	var row = _p1._0;
	var col = _p1._1;
	var prevline = A2(
		_elm_lang$core$Maybe$withDefault,
				...
				model,
				{
					buffer: _elm_lang$core$Native_Utils.eq(prev_level, cur_level) ? A2(
						...
						A2(
							_minekoa$elm_text_editor$TextEditor_Buffer$Position,
							row,
							col + _elm_lang$core$String$length(indent_str)),
						A3(
							_minekoa$elm_text_editor$TextEditor_Buffer$insertAt,
							A2(
								_minekoa$elm_text_editor$TextEditor_Buffer$Position,
...
var _minekoa$elm_text_editor$TextEditor_Core_Commands$killWord = function (model) {
	var bm = function (_p2) {
		return _minekoa$elm_text_editor$TextEditor_Buffer$selectNextWord(
			_minekoa$elm_text_editor$TextEditor_Buffer$selectionClear(_p2));
	}(model.buffer);
	var delete_str = A2(
		_elm_lang$core$Maybe$withDefault,
		'',
		A2(
			...
			function (sel) {
				return _elm_lang$core$Maybe$Just(
					A2(_minekoa$elm_text_editor$TextEditor_Buffer$readRange, sel, bm));
			},
			bm.selection));
	var _p3 = bm.selection;
	if (_p3.ctor === 'Just') {
		return _minekoa$elm_text_editor$TextEditor_Core$withEnsureVisibleCmd(
			_minekoa$elm_text_editor$TextEditor_Core$blinkBlock(
				_elm_lang$core$Native_Utils.update(
					model,
					{
						copyStore: _elm_lang$core$Native_Utils.eq(
							model.lastCommand,
							_elm_lang$core$Maybe$Just('killWord')) ? A2(_elm_lang$core$Basics_ops['++'], model.copyStore, delete_str) : delete_str,
						buffer: _minekoa$elm_text_editor$TextEditor_Buffer$selectionClear(
							A2(_minekoa$elm_text_editor$TextEditor_Buffer$deleteRange, _p3._0, bm))
					})));
	} else {
		return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
	}
...
var _minekoa$elm_text_editor$TextEditor_Core_Commands$killLine = function (model) {
	...
	var line = _minekoa$elm_text_editor$TextEditor_Buffer$currentLine(model.buffer);
	var cur = model.buffer.cursor;
	var delete_str = function (l) {
		return (_elm_lang$core$Native_Utils.eq(l, '') && (!isEOFLine(cur.row))) ? '\n' : l;
	}(
		A2(_elm_lang$core$String$dropLeft, cur.column, line));
	var delete_range = _elm_lang$core$Native_Utils.eq(delete_str, '\n') ? A2(
		_minekoa$elm_text_editor$TextEditor_Buffer$Range,
		cur,
		A2(_minekoa$elm_text_editor$TextEditor_Buffer$Position, cur.row + 1, 0)) : A2(
		_minekoa$elm_text_editor$TextEditor_Buffer$Range,
		cur,
		A2(
			_minekoa$elm_text_editor$TextEditor_Buffer$Position,
			cur.row,
			_elm_lang$core$String$length(line)));
	return function (m) {
		return _minekoa$elm_text_editor$TextEditor_Core$withEnsureVisibleCmd(
			A2(
				_minekoa$elm_text_editor$TextEditor_Core$setEventRequest,
...
var _minekoa$elm_text_editor$TextEditor_Core_Commands$gotoMark = _minekoa$elm_text_editor$TextEditor_Core_Commands$moveF(_minekoa$elm_text_editor$TextEditor_Buffer$gotoMark);
var _minekoa$elm_text_editor$TextEditor_Core_Commands$markFlip = _minekoa$elm_text_editor$TextEditor_Core_Commands$moveF(
	function (m) {
...
var _minekoa$elm_text_editor$TextEditor_Core_Commands$markClear = _minekoa$elm_text_editor$TextEditor_Core_Commands$moveF(_minekoa$elm_text_editor$TextEditor_Buffer$markClear);
var _minekoa$elm_text_editor$TextEditor_Core_Commands$markSet = _minekoa$elm_text_editor$TextEditor_Core_Commands$moveF(_minekoa$elm_text_editor$TextEditor_Buffer$markSet);
...
var _minekoa$elm_text_editor$TextEditor_Core_Commands$selectNextWord = _minekoa$elm_text_editor$TextEditor_Core_Commands$moveF(_minekoa$elm_text_editor$TextEditor_Buffer$selectNextWord);
var _minekoa$elm_text_editor$TextEditor_Core_Commands$selectPreviosWord = _minekoa$elm_text_editor$TextEditor_Core_Commands$moveF(_minekoa$elm_text_editor$TextEditor_Buffer$selectPreviosWord);
var _minekoa$elm_text_editor$TextEditor_Core_Commands$selectNextLine = _minekoa$elm_text_editor$TextEditor_Core_Commands$moveF(_minekoa$elm_text_editor$TextEditor_Buffer$selectNextLine);
var _minekoa$elm_text_editor$TextEditor_Core_Commands$selectPreviosLine = _minekoa$elm_text_editor$TextEditor_Core_Commands$moveF(_minekoa$elm_text_editor$TextEditor_Buffer$selectPreviosLine);
var _minekoa$elm_text_editor$TextEditor_Core_Commands$selectForward = _minekoa$elm_text_editor$TextEditor_Core_Commands$moveF(_minekoa$elm_text_editor$TextEditor_Buffer$selectForward);
var _minekoa$elm_text_editor$TextEditor_Core_Commands$selectBackward = _minekoa$elm_text_editor$TextEditor_Core_Commands$moveF(_minekoa$elm_text_editor$TextEditor_Buffer$selectBackward);
var _minekoa$elm_text_editor$TextEditor_Core_Commands$movePreviosWord = _minekoa$elm_text_editor$TextEditor_Core_Commands$moveF(_minekoa$elm_text_editor$TextEditor_Buffer$movePreviosWord);
var _minekoa$elm_text_editor$TextEditor_Core_Commands$moveNextWord = _minekoa$elm_text_editor$TextEditor_Core_Commands$moveF(_minekoa$elm_text_editor$TextEditor_Buffer$moveNextWord);
...
var _minekoa$elm_text_editor$TextEditor_Core_Commands$moveEOL = function (model) {
	var col = _elm_lang$core$String$length(
		_minekoa$elm_text_editor$TextEditor_Buffer$currentLine(model.buffer));
	return A2(
		_minekoa$elm_text_editor$TextEditor_Core_Commands$moveF,
		_minekoa$elm_text_editor$TextEditor_Buffer$moveAt(
			A2(_minekoa$elm_text_editor$TextEditor_Buffer$Position, model.buffer.cursor.row, col)),
		model);
};
var _minekoa$elm_text_editor$TextEditor_Core_Commands$moveBOL = function (model) {
	return A2(
		_minekoa$elm_text_editor$TextEditor_Core_Commands$moveF,
		_minekoa$elm_text_editor$TextEditor_Buffer$moveAt(
			A2(_minekoa$elm_text_editor$TextEditor_Buffer$Position, model.buffer.cursor.row, 0)),
		model);
};
var _minekoa$elm_text_editor$TextEditor_Core_Commands$moveNextLine = _minekoa$elm_text_editor$TextEditor_Core_Commands$moveF(_minekoa$elm_text_editor$TextEditor_Buffer$moveNextLine);
var _minekoa$elm_text_editor$TextEditor_Core_Commands$movePreviosLine = _minekoa$elm_text_editor$TextEditor_Core_Commands$moveF(_minekoa$elm_text_editor$TextEditor_Buffer$movePreviosLine);
...
var _minekoa$elm_text_editor$TextEditor_KeyboardEvent$KeyboardEvent = F6(
	function (a, b, c, d, e, f) {
		return {altKey: a, ctrlKey: b, keyCode: c, metaKey: d, repeat: e, shiftKey: f};
	});
var _minekoa$elm_text_editor$TextEditor_KeyboardEvent$decodeKeyboardEvent = A7(
	_elm_lang$core$Json_Decode$map6,
	_minekoa$elm_text_editor$TextEditor_KeyboardEvent$KeyboardEvent,
...
var _minekoa$elm_text_editor$TextEditor_KeyboardEvent$considerKeyboardEvent = function (func) {
	return A2(
		_elm_lang$core$Json_Decode$andThen,
		function (event) {
			var _p0 = func(event);
...
var _minekoa$elm_text_editor$TextEditor_TextMarker$toString = function (txts) {
	return _elm_lang$core$String$concat(
		A2(
			...
			function (txt) {
				var _p0 = txt;
				if (_p0.ctor === 'Marked') {
					return _elm_lang$core$String$fromList(_p0._1);
				} else {
...
var _minekoa$elm_text_editor$TextEditor_TextMarker$toHtml = function (txts) {
	return A2(
		_elm_lang$core$List$map,
		function (txt) {
			var _p1 = txt;
				...
				return A2(
					...
					},
					{
						...
						_0: _elm_lang$html$Html$text(
							_elm_lang$core$String$fromList(_p1._1)),
						_1: {ctor: '[]'}
					});
			} else {
				return _elm_lang$html$Html$text(
					_elm_lang$core$String$fromList(_p1._0));
			}
		},
		txts);
};
var _minekoa$elm_text_editor$TextEditor_TextMarker$Marked = F2(
	function (a, b) {
		return {ctor: 'Marked', _0: a, _1: b};
	});
var _minekoa$elm_text_editor$TextEditor_TextMarker$Plane = function (a) {
	return {ctor: 'Plane', _0: a};
};
var _minekoa$elm_text_editor$TextEditor_TextMarker$deepReverse = function (lst) {
	return _elm_lang$core$List$reverse(
		A2(
			_elm_lang$core$List$map,
			function (elm) {
				var _p2 = elm;
				if (_p2.ctor === 'Plane') {
					return _minekoa$elm_text_editor$TextEditor_TextMarker$Plane(
						_elm_lang$core$List$reverse(_p2._0));
				} else {
					return A2(
						_minekoa$elm_text_editor$TextEditor_TextMarker$Marked,
						_p2._0,
...
var _minekoa$elm_text_editor$TextEditor_TextMarker$markupControlChars = F2(
	function (tabOrder, line) {
		var f = F3(
			function (str, n, outtxts) {
				f:
				while (true) {
					var _p3 = str;
					if (_p3.ctor === '::') {
						switch (_p3._0.valueOf()) {
							case '\t':
								...
								var rpl_txt = _elm_lang$core$List$reverse(
								...
								var _v4 = _p3._1,
									...
									_v6 = {
									ctor: '::',
									_0: A2(_minekoa$elm_text_editor$TextEditor_TextMarker$Marked, 'tab-face', rpl_txt),
									_1: outtxts
								};
								str = _v4;
								n = _v5;
							...
							default:
								...
								var _p5 = _p3._0;
								var _p4 = outtxts;
								if ((_p4.ctor === '::') && (_p4._0.ctor === 'Plane')) {
									var _v14 = _p6,
										_v15 = n + 1,
										_v16 = {
										ctor: '::',
										_0: _minekoa$elm_text_editor$TextEditor_TextMarker$Plane(
											{ctor: '::', _0: _p5, _1: _p4._0._0}),
										_1: _p4._1
									};
									str = _v14;
									n = _v15;
		...
		return _minekoa$elm_text_editor$TextEditor_TextMarker$deepReverse(
			A3(
				f,
				_elm_lang$core$String$toList(line),
				0,
...
var _minekoa$elm_text_editor$TextEditor_TextMarker$replaceTab = F2(
	function (tabOrder, line) {
		var f = F3(
			function (str, n, outchars) {
				f:
				while (true) {
					var _p7 = str;
					if (_p7.ctor === '::') {
						if (_p7._0.valueOf() === '\t') {
							...
							var _v21 = _p7._1,
								_v22 = n + sp_cnt,
								_v23 = A2(_elm_lang$core$Basics_ops['++'], rpl_txt, outchars);
							str = _v21;
							n = _v22;
							outchars = _v23;
							continue f;
							...
							var _v24 = _p7._1,
								_v25 = n + 1,
								_v26 = {ctor: '::', _0: _p7._0, _1: outchars};
							str = _v24;
							n = _v25;
							outchars = _v26;
							continue f;
		...
		return function (cs) {
			return {
				ctor: '::',
				_0: _minekoa$elm_text_editor$TextEditor_TextMarker$Plane(cs),
				_1: {ctor: '[]'}
			};
		}(
			_elm_lang$core$List$reverse(
...
var _minekoa$elm_text_editor$TextEditor_TextMarker$markupLine = F3(
	function (showControlCharactor, tabOrder, line) {
		var _p8 = showControlCharactor;
		if (_p8 === true) {
			return A2(
				_minekoa$elm_text_editor$TextEditor_TextMarker$markupControlChars,
				tabOrder,
				A2(_elm_lang$core$Basics_ops['++'], line, '\n'));
		} else {
			return A2(_minekoa$elm_text_editor$TextEditor_TextMarker$replaceTab, tabOrder, line);
		}
	});
var _minekoa$elm_text_editor$TextEditor_TextMarker$markupChank = F3(
	function (showControlCharactor, tabOrder, line) {
		var _p9 = showControlCharactor;
		if (_p9 === true) {
			return A2(_minekoa$elm_text_editor$TextEditor_TextMarker$markupControlChars, tabOrder, line);
		} else {
			return A2(_minekoa$elm_text_editor$TextEditor_TextMarker$replaceTab, tabOrder, line);
		}
	});

var _minekoa$elm_text_editor$TextEditor_Commands$nop = {id: 'nop', f: _minekoa$elm_text_editor$TextEditor_Core_Commands$nop};
...
var _minekoa$elm_text_editor$TextEditor_Commands$killWord = {id: 'killWord', f: _minekoa$elm_text_editor$TextEditor_Core_Commands$killWord};
...
var _minekoa$elm_text_editor$TextEditor_Commands$selectNextWord = {id: 'selectNextWord', f: _minekoa$elm_text_editor$TextEditor_Core_Commands$selectNextWord};
var _minekoa$elm_text_editor$TextEditor_Commands$selectPreviosWord = {id: 'selectPreviosWord', f: _minekoa$elm_text_editor$TextEditor_Core_Commands$selectPreviosWord};
var _minekoa$elm_text_editor$TextEditor_Commands$selectNextLine = {id: 'selectNextLine', f: _minekoa$elm_text_editor$TextEditor_Core_Commands$selectNextLine};
var _minekoa$elm_text_editor$TextEditor_Commands$selectPreviosLine = {id: 'selectPreviosLine', f: _minekoa$elm_text_editor$TextEditor_Core_Commands$selectPreviosLine};
...
var _minekoa$elm_text_editor$TextEditor_Commands$movePreviosWord = {id: 'movePreviosWord', f: _minekoa$elm_text_editor$TextEditor_Core_Commands$movePreviosWord};
...
var _minekoa$elm_text_editor$TextEditor_Commands$moveNextLine = {id: 'moveNextLine', f: _minekoa$elm_text_editor$TextEditor_Core_Commands$moveNextLine};
var _minekoa$elm_text_editor$TextEditor_Commands$movePreviosLine = {id: 'movePreviosLine', f: _minekoa$elm_text_editor$TextEditor_Core_Commands$movePreviosLine};
...
var _minekoa$elm_text_editor$TextEditor_Style$encodeColorStyle = function (sty) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
...
var _minekoa$elm_text_editor$TextEditor_Style$encodeFontFaceStyle = function (sty) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
...
var _minekoa$elm_text_editor$TextEditor_Style$encodeLineNumberStyle = function (sty) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
...
var _minekoa$elm_text_editor$TextEditor_Style$encodeCodeStyle = function (sty) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
...
var _minekoa$elm_text_editor$TextEditor_Style$jsonEncode = function (sty) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
				...
				_1: A2(
					...
					A2(
						...
						function (s) {
							return _elm_lang$core$Maybe$Just(
								_minekoa$elm_text_editor$TextEditor_Style$encodeCodeStyle(s));
						},
						sty.common))
			},
			_1: {
				...
				_0: {
					...
					_1: A2(
						...
						A2(
							...
							function (s) {
								return _elm_lang$core$Maybe$Just(
									_minekoa$elm_text_editor$TextEditor_Style$encodeLineNumberStyle(s));
							},
							sty.numberLine))
				},
				_1: {
					...
					_0: {
						...
						_1: A2(
							...
							A2(
								...
								function (s) {
									return _elm_lang$core$Maybe$Just(
										_minekoa$elm_text_editor$TextEditor_Style$encodeColorStyle(s));
								},
								sty.cursor))
					},
					_1: {
						...
						_0: {
							...
							_1: A2(
								...
								A2(
									...
									function (s) {
										return _elm_lang$core$Maybe$Just(
											_minekoa$elm_text_editor$TextEditor_Style$encodeFontFaceStyle(s));
									},
									sty.selection))
						},
						_1: {
										...
										A2(
											...
											function (_p0) {
												...
												return {
													ctor: '_Tuple2',
													_0: _p1._0,
													_1: _minekoa$elm_text_editor$TextEditor_Style$encodeFontFaceStyle(_p1._1)
												};
											},
											sty.fontFaces))
								},
...
var _minekoa$elm_text_editor$TextEditor_Style$modernMinchoStyle = {
	...
	fontFaces: {
		...
		_0: {
			ctor: '_Tuple2',
			_0: 'tab-face',
			_1: {color: '', backgroundColor: '', opacity: '0.2'}
		},
		_1: {
			ctor: '::',
			_0: {
...
var _minekoa$elm_text_editor$TextEditor_Style$Style = F6(
	function (a, b, c, d, e, f) {
		return {common: a, numberLine: b, cursor: c, selection: d, composing: e, fontFaces: f};
	});
var _minekoa$elm_text_editor$TextEditor_Style$CodeStyle = F5(
	function (a, b, c, d, e) {
		return {color: a, backgroundColor: b, opacity: c, fontFamily: d, fontSize: e};
	});
var _minekoa$elm_text_editor$TextEditor_Style$decodeCodeStyle = A6(
...
var _minekoa$elm_text_editor$TextEditor_Style$LineNumberStyle = F5(
	function (a, b, c, d, e) {
		return {color: a, backgroundColor: b, opacity: c, borderRight: d, marginRight: e};
	});
var _minekoa$elm_text_editor$TextEditor_Style$decodeLineNumberStyle = A6(
	_elm_lang$core$Json_Decode$map5,
...
var _minekoa$elm_text_editor$TextEditor_Style$FontFaceStyle = F3(
	function (a, b, c) {
		return {color: a, backgroundColor: b, opacity: c};
	});
var _minekoa$elm_text_editor$TextEditor_Style$decodeFontFaceStyle = A4(
	_elm_lang$core$Json_Decode$map3,
	_minekoa$elm_text_editor$TextEditor_Style$FontFaceStyle,
	A2(_elm_lang$core$Json_Decode$field, 'color', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'backgroundColor', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'opacity', _elm_lang$core$Json_Decode$string));
var _minekoa$elm_text_editor$TextEditor_Style$ColorStyle = F2(
	function (a, b) {
		return {color: a, opacity: b};
	});
var _minekoa$elm_text_editor$TextEditor_Style$decodeColorStyle = A3(
	_elm_lang$core$Json_Decode$map2,
	_minekoa$elm_text_editor$TextEditor_Style$ColorStyle,
	A2(_elm_lang$core$Json_Decode$field, 'color', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'opacity', _elm_lang$core$Json_Decode$string));
var _minekoa$elm_text_editor$TextEditor_Style$jsonDecode = A7(
	_elm_lang$core$Json_Decode$map6,
	_minekoa$elm_text_editor$TextEditor_Style$Style,
	A2(
		_elm_lang$core$Json_Decode$field,
		'common',
		_elm_lang$core$Json_Decode$nullable(_minekoa$elm_text_editor$TextEditor_Style$decodeCodeStyle)),
	A2(
		_elm_lang$core$Json_Decode$field,
		'numberLine',
		_elm_lang$core$Json_Decode$nullable(_minekoa$elm_text_editor$TextEditor_Style$decodeLineNumberStyle)),
	A2(
		_elm_lang$core$Json_Decode$field,
		'cursor',
		_elm_lang$core$Json_Decode$nullable(_minekoa$elm_text_editor$TextEditor_Style$decodeColorStyle)),
	A2(
		_elm_lang$core$Json_Decode$field,
		'selection',
		_elm_lang$core$Json_Decode$nullable(_minekoa$elm_text_editor$TextEditor_Style$decodeFontFaceStyle)),
	A2(
		_elm_lang$core$Json_Decode$field,
		'composing',
		_elm_lang$core$Json_Decode$nullable(_minekoa$elm_text_editor$TextEditor_Style$decodeFontFaceStyle)),
	A2(
		_elm_lang$core$Json_Decode$field,
		'fontFaces',
		_elm_lang$core$Json_Decode$keyValuePairs(_minekoa$elm_text_editor$TextEditor_Style$decodeFontFaceStyle)));
...
var _minekoa$elm_text_editor$TextEditor_KeyBind$emacsLike = {
	...
	_1: {
		...
		_1: {
			ctor: '::',
			_0: {ctrl: true, alt: false, shift: false, code: 78, f: _minekoa$elm_text_editor$TextEditor_Commands$moveNextLine},
			_1: {
				ctor: '::',
				_0: {ctrl: true, alt: false, shift: false, code: 80, f: _minekoa$elm_text_editor$TextEditor_Commands$movePreviosLine},
				_1: {
					ctor: '::',
					_0: {ctrl: false, alt: true, shift: false, code: 70, f: _minekoa$elm_text_editor$TextEditor_Commands$moveNextWord},
					_1: {
						ctor: '::',
						_0: {ctrl: false, alt: true, shift: false, code: 66, f: _minekoa$elm_text_editor$TextEditor_Commands$movePreviosWord},
						_1: {
							ctor: '::',
										...
										_1: {
											...
											_1: {
												...
												_1: {
													...
													_1: {
														ctor: '::',
														_0: {ctrl: false, alt: true, shift: false, code: 68, f: _minekoa$elm_text_editor$TextEditor_Commands$killWord},
														_1: {
															ctor: '::',
															_0: {
																ctrl: true,
...
var _minekoa$elm_text_editor$TextEditor_KeyBind$gates = {
	...
	_1: {
		...
		_1: {
			ctor: '::',
			_0: {ctrl: false, alt: false, shift: true, code: 38, f: _minekoa$elm_text_editor$TextEditor_Commands$selectPreviosLine},
			_1: {
				ctor: '::',
				_0: {ctrl: false, alt: false, shift: true, code: 40, f: _minekoa$elm_text_editor$TextEditor_Commands$selectNextLine},
				_1: {
					ctor: '::',
					_0: {ctrl: false, alt: true, shift: false, code: 37, f: _minekoa$elm_text_editor$TextEditor_Commands$movePreviosWord},
					_1: {
						ctor: '::',
						_0: {ctrl: false, alt: true, shift: false, code: 39, f: _minekoa$elm_text_editor$TextEditor_Commands$moveNextWord},
						_1: {
							ctor: '::',
							_0: {ctrl: false, alt: true, shift: true, code: 37, f: _minekoa$elm_text_editor$TextEditor_Commands$selectPreviosWord},
							_1: {
								ctor: '::',
								_0: {ctrl: false, alt: true, shift: true, code: 39, f: _minekoa$elm_text_editor$TextEditor_Commands$selectNextWord},
								_1: {
									ctor: '::',
...
var _minekoa$elm_text_editor$TextEditor_KeyBind$basic = {
	...
	_1: {
		...
		_1: {
			ctor: '::',
			_0: {ctrl: false, alt: false, shift: false, code: 38, f: _minekoa$elm_text_editor$TextEditor_Commands$movePreviosLine},
			_1: {
				ctor: '::',
				_0: {ctrl: false, alt: false, shift: false, code: 40, f: _minekoa$elm_text_editor$TextEditor_Commands$moveNextLine},
				_1: {
					ctor: '::',
...
var _minekoa$elm_text_editor$TextEditor$onKeyDownForDeepAnalayze = F2(
	function (keymap, tagger) {
		return A3(
			_elm_lang$html$Html_Events$onWithOptions,
			'keydown',
			{stopPropagation: false, preventDefault: false},
			_minekoa$elm_text_editor$TextEditor_KeyboardEvent$considerKeyboardEvent(
				function (e) {
					var _p3 = A2(
...
var _minekoa$elm_text_editor$TextEditor$onKeyDown = F2(
	function (keymap, tagger) {
		return A3(
			_elm_lang$html$Html_Events$onWithOptions,
			'keydown',
...
var _minekoa$elm_text_editor$TextEditor$stylesheet = F2(
	function (sty, frameID) {
		...
		var tagstring = F2(
			function (tag, val) {
				return _elm_lang$core$Native_Utils.eq(val, '') ? '' : _elm_lang$core$String$concat(
					{
						ctor: '::',
						_0: tag,
						_1: {
		...
		var codesty2str = function (s) {
			return _elm_lang$core$String$concat(
				{
					ctor: '::',
					_0: A2(tagstring, 'color', s.color),
					_1: {
						ctor: '::',
						_0: A2(tagstring, 'background-color', s.backgroundColor),
						_1: {
							ctor: '::',
							_0: A2(tagstring, 'font-family', s.fontFamily),
							_1: {
								ctor: '::',
								_0: A2(tagstring, 'font-size', s.fontSize),
								_1: {
									ctor: '::',
									_0: A2(tagstring, 'opacity', s.opacity),
									_1: {ctor: '[]'}
								}
							}
						}
			...
			return _elm_lang$core$String$concat(
				{
					...
					_1: {
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: A2(tagstring, 'border-right', s.borderRight),
								_1: {
									ctor: '::',
									_0: A2(tagstring, 'margin-right', s.marginRight),
									_1: {ctor: '[]'}
								}
							}
						}
		...
		var cursty2str = function (s) {
			return _elm_lang$core$String$concat(
				{
					ctor: '::',
					_0: A2(tagstring, 'background-color', s.color),
					_1: {
						ctor: '::',
						_0: A2(tagstring, 'opacity', s.opacity),
						_1: {ctor: '[]'}
					...
					_elm_lang$core$String$concat(
						A2(
							...
							A2(
								_elm_lang$core$List$map,
								function (s) {
									var val = _elm_lang$core$Tuple$second(s);
									var cls = _elm_lang$core$Tuple$first(s);
									return A2(
										csscls,
										cls,
										ffacesty2str(val));
...
var _minekoa$elm_text_editor$TextEditor$cursorView = function (model) {
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('elm-text-editor-cursor'),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$style(
					A2(
						...
						A2(
							...
							(model.focus && blink_off(model.blink)) ? {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'opacity', _1: '0.0'},
								_1: {ctor: '[]'}
							} : {ctor: '[]'}))),
				_1: {
					ctor: '::',
...
var _minekoa$elm_text_editor$TextEditor$compositionPreview = function (compositionData) {
	var _p7 = compositionData;
	if (_p7.ctor === 'Just') {
		return A2(
			_elm_lang$html$Html$span,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('elm-text-editor-composing'),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$style(
						{
...
var _minekoa$elm_text_editor$TextEditor$pad = function (model) {
	...
	return A2(
		...
		_minekoa$elm_text_editor$TextEditor_TextMarker$toHtml(
			A3(
				_minekoa$elm_text_editor$TextEditor_TextMarker$markupChank,
...
var _minekoa$elm_text_editor$TextEditor$markerLayer = function (model) {
	...
	if (_p8.ctor === 'Nothing') {
		...
		var epix = calc_w(
			_minekoa$elm_text_editor$TextEditor_TextMarker$toString(
				A3(
					_minekoa$elm_text_editor$TextEditor_TextMarker$markupChank,
					model.option.showControlCharactor,
					model.option.tabOrder,
					A2(
						...
						A2(
							_elm_lang$core$Maybe$withDefault,
							'',
							A2(_minekoa$elm_text_editor$TextEditor_Buffer$line, epos.row, model.buffer))))));
				...
				A3(
					...
					A2(
						...
						A2(
							_elm_lang$core$Maybe$withDefault,
							'',
							A2(_minekoa$elm_text_editor$TextEditor_Buffer$line, bpos.row, model.buffer))))));
		var ms = A2(
			_elm_lang$core$List$map,
			function (r) {
				var ce = _elm_lang$core$Native_Utils.eq(r, epos.row) ? epos.column : _elm_lang$core$String$length(
					A2(
						_elm_lang$core$Maybe$withDefault,
						'',
						A2(_minekoa$elm_text_editor$TextEditor_Buffer$line, r, model.buffer)));
				var cb = _elm_lang$core$Native_Utils.eq(r, bpos.row) ? bpos.column : 0;
				var pe = _elm_lang$core$Native_Utils.eq(r, epos.row) ? epix : (rect.right - rect.left);
				var pb = _elm_lang$core$Native_Utils.eq(r, bpos.row) ? bpix : 0;
				return {row: r, begin_col: cb, end_col: ce, begin_px: pb, end_px: pe};
			},
			A2(_elm_lang$core$List$range, bpos.row, epos.row));
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
			...
			A2(
				...
				function (m) {
					return A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('elm-text-editor-selection'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$style(
									{
								...
								return _elm_lang$core$Native_Utils.eq(
									_elm_lang$core$String$length(
										A2(
											_elm_lang$core$Maybe$withDefault,
											'',
											A2(_minekoa$elm_text_editor$TextEditor_Buffer$line, m.row, model.buffer))),
									m.end_col) ? A3(_minekoa$elm_text_editor$TextEditor_TextMarker$markupLine, model.option.showControlCharactor, model.option.tabOrder, ln) : A3(_minekoa$elm_text_editor$TextEditor_TextMarker$markupChank, model.option.showControlCharactor, model.option.tabOrder, ln);
							}(
								A2(
									_elm_lang$core$String$left,
...
var _minekoa$elm_text_editor$TextEditor$selectedTouchPad = function (model) {
	var _p10 = model.buffer.selection;
	if (_p10.ctor === 'Nothing') {
		return {ctor: '[]'};
	} else {
		var _p11 = _p10._0;
		var epos = A2(_minekoa$elm_text_editor$TextEditor_Buffer$isPreviosPos, _p11.begin, _p11.end) ? _p11.end : _p11.begin;
		var bpos = A2(_minekoa$elm_text_editor$TextEditor_Buffer$isPreviosPos, _p11.begin, _p11.end) ? _p11.begin : _p11.end;
		return A2(
			_elm_lang$core$List$map,
			function (row) {
				return A2(
				...
				function (n, ln) {
					return A2(
						...
						(_elm_lang$core$Native_Utils.eq(n, cursor.row) && (!_elm_lang$core$Native_Utils.eq(model.compositionPreview, _elm_lang$core$Maybe$Nothing))) ? {
							...
							_1: {
								...
								_1: {
									...
									_0: A2(
										...
										_minekoa$elm_text_editor$TextEditor_TextMarker$toHtml(
											A3(
												_minekoa$elm_text_editor$TextEditor_TextMarker$markupLine,
												model.option.showControlCharactor,
												model.option.tabOrder,
							...
							A3(_minekoa$elm_text_editor$TextEditor_TextMarker$markupLine, model.option.showControlCharactor, model.option.tabOrder, ln)));
				}),
			contents));
};
var _minekoa$elm_text_editor$TextEditor$lineNumArea = function (model) {
	...
	return A2(
		_elm_lang$html$Html$div,
		{
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('elm-text-editor-linenum'),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$style(
						{
...
var _minekoa$elm_text_editor$TextEditor$xToColumn = F3(
	function (model, line, pos_x) {
		var markup_ln = function (_p12) {
			return _minekoa$elm_text_editor$TextEditor_TextMarker$toString(
				A3(_minekoa$elm_text_editor$TextEditor_TextMarker$markupChank, model.option.showControlCharactor, model.option.tabOrder, _p12));
		};
		var calc_w = _minekoa$elm_text_editor$TextEditor$calcTextWidth(
			_minekoa$elm_text_editor$TextEditor_Core$rulerID(model));
		var calc_col = F3(
...
var _minekoa$elm_text_editor$TextEditor$Model = F6(
	function (a, b, c, d, e, f) {
		return {core: a, enableComposer: b, drag: c, keymap: d, style: e, event_log: f};
	});
...
var _minekoa$elm_text_editor$TextEditor$logging = F3(
	function (ev_name, ev_data, _p16) {
		var _p17 = _p16;
		var _p20 = _p17._0;
		var _p19 = _p17._1;
		var _p18 = _p20.event_log;
		if (_p18.ctor === 'Just') {
			return {
				ctor: '_Tuple2',
				_0: _p20,
...
var _minekoa$elm_text_editor$TextEditor$KeyUp = function (a) {
...
var _minekoa$elm_text_editor$TextEditor$cursorLayer = F2(
	function (keymap, model) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
									...
									_0: A2(
										_elm_lang$html$Html$textarea,
										{
											...
											_1: {
												...
												_1: {
													ctor: '::',
													_0: A2(_minekoa$elm_text_editor$TextEditor$onKeyDown, keymap, _minekoa$elm_text_editor$TextEditor$KeyDown),
													_1: {
														ctor: '::',
														_0: _minekoa$elm_text_editor$TextEditor$onKeyPress(_minekoa$elm_text_editor$TextEditor$KeyPress),
														_1: {
															ctor: '::',
															_0: _minekoa$elm_text_editor$TextEditor$onKeyUp(_minekoa$elm_text_editor$TextEditor$KeyUp),
															_1: {
																ctor: '::',
...
var _minekoa$elm_text_editor$TextEditor$UpdateContents = function (a) {
	return {ctor: 'UpdateContents', _0: a};
};
var _minekoa$elm_text_editor$TextEditor$invokeEvent = function (_p21) {
	var _p22 = _p21;
	var _p26 = _p22._0;
	var _p25 = _p22._1;
	var _p23 = _p26.core.eventRequest;
	if (_p23.ctor === 'Just') {
		return {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Native_Utils.update(
				_p26,
				{
					core: _minekoa$elm_text_editor$TextEditor_Core$clearEventRequest(_p26.core)
				}),
			_1: _elm_lang$core$Platform_Cmd$batch(
				{
					ctor: '::',
					...
					_1: {
						...
						_0: A2(
							_elm_lang$core$Task$perform,
							function (_p24) {
								return _minekoa$elm_text_editor$TextEditor$UpdateContents(_p23._0._0);
							},
							_elm_lang$core$Task$succeed(true)),
						_1: {ctor: '[]'}
					}
...
var _minekoa$elm_text_editor$TextEditor$init = F5(
	function (id, opts, style, keymap, text) {
		var _p27 = A3(_minekoa$elm_text_editor$TextEditor_Core$init, id, opts, text);
		var coreM = _p27._0;
		var coreC = _p27._1;
		return {
			ctor: '_Tuple2',
			_0: A6(_minekoa$elm_text_editor$TextEditor$Model, coreM, false, false, keymap, style, _elm_lang$core$Maybe$Nothing),
...
var _minekoa$elm_text_editor$TextEditor$initLikeNotepad = F2(
	function (id, text) {
		return A5(
			_minekoa$elm_text_editor$TextEditor$init,
			id,
			_minekoa$elm_text_editor$TextEditor_Option$notepadLikeOptions,
			_minekoa$elm_text_editor$TextEditor_Style$notepadLikeStyle,
...
var _minekoa$elm_text_editor$TextEditor$execCommand = F2(
	function (cmd, model) {
		return A3(
			...
			'exec-comd',
			cmd.id,
			_minekoa$elm_text_editor$TextEditor$invokeEvent(
		...
		if (_p29.ctor === 'Just') {
			...
			return A3(
				...
				A2(
					...
					A2(_elm_lang$core$Basics_ops['++'], ', editorcmd=', _p30.id)),
				A2(_minekoa$elm_text_editor$TextEditor$exec_command_proc, _p30, model));
		} else {
			return A3(
				_minekoa$elm_text_editor$TextEditor$logging,
				'keydown',
...
var _minekoa$elm_text_editor$TextEditor$compositionEnd = F2(
	function (data, model) {
		var _p31 = A2(_minekoa$elm_text_editor$TextEditor_Core$compositionEnd, data, model.core);
		var m = _p31._0;
		var c = _p31._1;
		return A3(
			_minekoa$elm_text_editor$TextEditor$logging,
	...
	function (model, _p32) {
		...
		return {
			...
			_0: _elm_lang$core$Native_Utils.update(
				model,
				{core: _p33._0}),
			_1: A2(_elm_lang$core$Platform_Cmd$map, _minekoa$elm_text_editor$TextEditor$CoreMsg, _p33._1)
		};
	});
var _minekoa$elm_text_editor$TextEditor$input = F2(
	function (s, model) {
		var _p34 = model.enableComposer || _elm_lang$core$String$isEmpty(s);
		if (_p34 === true) {
			return A3(
				_minekoa$elm_text_editor$TextEditor$logging,
				'input (ignored)',
...
var _minekoa$elm_text_editor$TextEditor$update = F2(
	function (msg, model) {
		...
		switch (_p35.ctor) {
			case 'CoreMsg':
				var _p36 = A2(_minekoa$elm_text_editor$TextEditor_Core$update, _p35._0, model.core);
				var cm = _p36._0;
				var cc = _p36._1;
				return _minekoa$elm_text_editor$TextEditor$invokeEvent(
					{
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							...
							A2(
								...
								A2(
									...
									A2(
										_minekoa$elm_text_editor$TextEditor$updateMap,
										model,
										A2(_minekoa$elm_text_editor$TextEditor_Core_Commands$paste, _p37, model.core)))))));
			case 'Copied':
				return _minekoa$elm_text_editor$TextEditor$invokeEvent(
					A3(
						_minekoa$elm_text_editor$TextEditor$logging,
			...
			case 'Input':
				return _minekoa$elm_text_editor$TextEditor$invokeEvent(
					A2(_minekoa$elm_text_editor$TextEditor$input, _p35._0, model));
			case 'KeyDown':
				return _minekoa$elm_text_editor$TextEditor$invokeEvent(
					A2(_minekoa$elm_text_editor$TextEditor$keyDown, _p35._0, model));
			case 'KeyPress':
				return A2(_minekoa$elm_text_editor$TextEditor$keyPress, _p35._0, model);
			case 'KeyUp':
				return A2(_minekoa$elm_text_editor$TextEditor$keyUp, _p35._0, model);
			case 'CompositionStart':
				return A2(_minekoa$elm_text_editor$TextEditor$compositionStart, _p35._0, model);
			case 'CompositionUpdate':
				return A2(_minekoa$elm_text_editor$TextEditor$compositionUpdate, _p35._0, model);
			case 'CompositionEnd':
				return _minekoa$elm_text_editor$TextEditor$invokeEvent(
					A2(_minekoa$elm_text_editor$TextEditor$compositionEnd, _p35._0, model));
			case 'FocusIn':
				var cm = model.core;
				return {
					ctor: '_Tuple2',
			...
			case 'DragStart':
				var _p40 = _p35._0;
				var xy = {x: _p40.pageX, y: _p40.pageY};
				...
				var _p38 = A2(
					...
					{
						ctor: '::',
						_0: _minekoa$elm_text_editor$TextEditor_Core_Commands$moveAt(chpos),
						_1: {
							ctor: '::',
				...
				var cm = _p38._0;
				var cc = _p38._1;
				var _p39 = _p40.button;
				switch (_p39.ctor) {
					case 'LeftMouse':
						return A3(
							_minekoa$elm_text_editor$TextEditor$logging,
							'dragstart',
							A2(_minekoa$elm_text_editor$TextEditor$printDragInfo, xy, chpos),
							{
								ctor: '_Tuple2',
								...
								_elm_lang$core$String$concat(
									{
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$core$Basics$toString(chpos.row),
											_1: {
												ctor: '::',
												_0: ', ',
												_1: {
													ctor: '::',
													_0: _elm_lang$core$Basics$toString(chpos.column),
													_1: {
														ctor: '::',
														_0: ')',
														_1: {ctor: '[]'}
			...
			case 'DragAt':
				var _p42 = _p35._0;
				var chpos = A2(_minekoa$elm_text_editor$TextEditor$geoPosToCharPos, model.core, _p42);
				var _p41 = A2(_minekoa$elm_text_editor$TextEditor_Core_Commands$selectAt, chpos, model.core);
				var cm = _p41._0;
				var cc = _p41._1;
				return A3(
					_minekoa$elm_text_editor$TextEditor$logging,
					'dragat',
					A2(_minekoa$elm_text_editor$TextEditor$printDragInfo, _p42, chpos),
					A2(
						_minekoa$elm_text_editor$TextEditor$setLastCommand,
						_elm_lang$core$String$concat(
							{
			...
			default:
				var new_event = {name: _p35._0, data: _p35._1, date: _p35._2};
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
...
var _minekoa$elm_text_editor$TextEditor$codeArea = F2(
	function (keymap, model) {
		return A2(
			_elm_lang$html$Html$div,
			{
			...
			},
			{
				...
				_1: {
					ctor: '::',
					_0: A2(_minekoa$elm_text_editor$TextEditor$cursorLayer, keymap, model),
					_1: {
						ctor: '::',
...
var _minekoa$elm_text_editor$TextEditor$view = function (model) {
	return A2(
		...
		},
		{
			ctor: '::',
			_0: A2(
				_minekoa$elm_text_editor$TextEditor$stylesheet,
				model.style,
				_minekoa$elm_text_editor$TextEditor_Core$frameID(model.core)),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$div,
					{
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('elm-text-editor-scene'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$style(
									{
					...
					{
						ctor: '::',
						_0: _minekoa$elm_text_editor$TextEditor$presentation(model),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
		...
		return _elm_lang$core$String$concat(
			{
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$core$Basics$toString(_p2.pos.row),
					_1: {
						ctor: '::',
						_0: ',',
						_1: {
							ctor: '::',
							_0: _elm_lang$core$Basics$toString(_p2.pos.column),
							_1: {
								ctor: '::',
								_0: '), actived=',
								_1: {
		...
		return _elm_lang$core$String$concat(
			{
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$core$Basics$toString(_p4.begin.row),
					_1: {
						ctor: '::',
						_0: ',',
						_1: {
							ctor: '::',
							_0: _elm_lang$core$Basics$toString(_p4.begin.column),
							_1: {
								ctor: '::',
								_0: ') ~ (',
								_1: {
									ctor: '::',
									_0: _elm_lang$core$Basics$toString(_p4.end.row),
									_1: {
										ctor: '::',
										_0: ',',
										_1: {
											ctor: '::',
											_0: _elm_lang$core$Basics$toString(_p4.end.column),
											_1: {
												ctor: '::',
												_0: ')',
												_1: {ctor: '[]'}
				...
				_0: A2(
					...
					A2(
						...
						function (c) {
							...
							var pos2str = function (p) {
								return A2(
									_elm_lang$core$Basics_ops['++'],
									'(',
									A2(
										_elm_lang$core$Basics_ops['++'],
										_elm_lang$core$Basics$toString(p.row),
										A2(
											_elm_lang$core$Basics_ops['++'],
											', ',
											A2(
												_elm_lang$core$Basics_ops['++'],
												_elm_lang$core$Basics$toString(p.column),
												')'))));
							};
										...
										},
										{
											...
											_0: _elm_lang$html$Html$text(
												A2(
													_elm_lang$core$Basics_ops['++'],
													'Insert ',
													A4(editParm2str, _p8._0, _p8._1, _p8._2, _p8._3))),
											_1: {ctor: '[]'}
										});
								case 'Cmd_Backspace':
									return A2(
...
var _minekoa$elm_text_editor$DebugMenu$update = F3(
	function (msg, editorModel, model) {
		var _p9 = msg;
		if (_p9.ctor === 'SelectSubMenu') {
			return {
				ctor: '_Tuple3',
				_0: editorModel,
				_1: _elm_lang$core$Native_Utils.update(
					model,
					{selectedSubMenu: _p9._0}),
...
var _minekoa$elm_text_editor$KeyBindMenu$editorCommandList = {
	...
	_1: {
		...
		_1: {
			ctor: '::',
			_0: _minekoa$elm_text_editor$TextEditor_Commands$movePreviosLine,
			_1: {
				ctor: '::',
				_0: _minekoa$elm_text_editor$TextEditor_Commands$moveNextLine,
				_1: {
					ctor: '::',
					_0: _minekoa$elm_text_editor$TextEditor_Commands$moveNextWord,
					_1: {
						ctor: '::',
						_0: _minekoa$elm_text_editor$TextEditor_Commands$movePreviosWord,
						_1: {
							ctor: '::',
							...
							_1: {
								...
								_1: {
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _minekoa$elm_text_editor$TextEditor_Commands$selectPreviosLine,
											_1: {
												ctor: '::',
												_0: _minekoa$elm_text_editor$TextEditor_Commands$selectNextLine,
												_1: {
													ctor: '::',
													_0: _minekoa$elm_text_editor$TextEditor_Commands$selectPreviosWord,
													_1: {
														ctor: '::',
														_0: _minekoa$elm_text_editor$TextEditor_Commands$selectNextWord,
														_1: {
															ctor: '::',
																								...
																								_1: {
																									...
																									_1: {
																										...
																										_1: {
																											...
																											_1: {
																												ctor: '::',
																												_0: _minekoa$elm_text_editor$TextEditor_Commands$killWord,
																												_1: {
																													ctor: '::',
																													_0: _minekoa$elm_text_editor$TextEditor_Commands$undo,
																													_1: {
																														ctor: '::',
																														_0: _minekoa$elm_text_editor$TextEditor_Commands$nop,
																														_1: {ctor: '[]'}
																													}
																												}
																											}
...
var _minekoa$elm_text_editor$KeyBindMenu$onKeyDown = function (tagger) {
	return A2(
		_elm_lang$html$Html_Events$on,
		'keydown',
		A2(_elm_lang$core$Json_Decode$map, tagger, _minekoa$elm_text_editor$TextEditor_KeyboardEvent$decodeKeyboardEvent));
};
...
var _minekoa$elm_text_editor$KeyBindMenu$update = F3(
	function (msg, keybinds, model) {
		...
		while (true) {
			...
			switch (_p4.ctor) {
				case 'LoadSetting':
					if ((_p4._0.ctor === '_Tuple2') && (_p4._0._0 === 'keybinds')) {
						return {
							ctor: '_Tuple3',
							_0: A2(
				...
				case 'TabKeyDown':
					var now_insertS = A2(
						...
						A2(
							...
							model.current));
					var _v7 = _minekoa$elm_text_editor$KeyBindMenu$InputText(
							...
							},
							{
								...
								_0: A2(
									...
									},
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text(
											_minekoa$elm_text_editor$StringTools$stringEscape(_p22._0)),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							});
...
var _minekoa$elm_text_editor$KeyBindMenu$editPageView = F2(
	function (edtbuf, model) {
		var isEditModeNew = function (m) {
			var _p23 = m.current;
			if (_p23.ctor === 'Just') {
				return _elm_lang$core$Native_Utils.eq(_p23._0.editmode, _minekoa$elm_text_editor$KeyBindMenu$EditModeNew);
			} else {
				return false;
			}
		};
			...
			},
			{
				...
				_1: {
					...
					_0: A2(
						...
						function () {
							var _p25 = model.current;
							if (_p25.ctor === 'Just') {
								var _p26 = _p25._0.editmode;
								switch (_p26.ctor) {
									case 'EditModeNew':
										return A2(
											_elm_lang$core$Basics_ops['++'],
...
var _minekoa$elm_text_editor$SoftwareKeyboard$update = F3(
	function (msg, model, editor) {
		...
		switch (_p0.ctor) {
			...
			case 'MovePreviosLine':
				return {
					ctor: '_Tuple2',
					_0: {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none},
					_1: A2(_minekoa$elm_text_editor$TextEditor$execCommand, _minekoa$elm_text_editor$TextEditor_Commands$movePreviosLine, editor)
				};
			case 'MoveNextLine':
				return {
					ctor: '_Tuple2',
					_0: {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none},
					_1: A2(_minekoa$elm_text_editor$TextEditor$execCommand, _minekoa$elm_text_editor$TextEditor_Commands$moveNextLine, editor)
				};
			case 'Insert':
				return {
					ctor: '_Tuple2',
...
var _minekoa$elm_text_editor$SoftwareKeyboard$MoveNextLine = {ctor: 'MoveNextLine'};
var _minekoa$elm_text_editor$SoftwareKeyboard$MovePreviosLine = {ctor: 'MovePreviosLine'};
												...
												_1: {
													...
													_0: A2(
														_elm_lang$html$Html$div,
														{
															...
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html_Events$onClick(_minekoa$elm_text_editor$SoftwareKeyboard$MovePreviosLine),
																_1: {
																	ctor: '::',
																	_0: _elm_lang$html$Html_Attributes$style(
																		{
													...
													_1: {
														...
														_0: A2(
															_elm_lang$html$Html$div,
															{
																...
																_1: {
																	ctor: '::',
																	_0: _elm_lang$html$Html_Events$onClick(_minekoa$elm_text_editor$SoftwareKeyboard$MoveNextLine),
																	_1: {
																		ctor: '::',
																		_0: _elm_lang$html$Html_Attributes$style(
																			{
...
var _minekoa$elm_text_editor$StyleMenu$update = F2(
	function (msg, model) {
		...
		switch (_p2.ctor) {
			case 'LoadSetting':
				if ((_p2._0.ctor === '_Tuple2') && (_p2._0._0 === 'style')) {
					return {
						ctor: '_Tuple2',
						_0: function (newstyle) {
							...
							A2(
								...
								A2(
									...
									A2(
										_elm_lang$core$Result$andThen,
										_elm_lang$core$Json_Decode$decodeString(_minekoa$elm_text_editor$TextEditor_Style$jsonDecode),
										A2(_elm_lang$core$Result$fromMaybe, 'value is nothing', _p2._0._1))))),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			...
			case 'Change_Common_BGColor':
				...
				var newstyle = A2(updateCommonBgColor, _p3, model.style);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							...
							editTarget: A3(
								...
								'bg-color',
								_minekoa$elm_text_editor$StyleMenu$Change_Common_BGColor,
								_minekoa$elm_text_editor$StyleMenu$bgColorList(_p3))
						}),
					_1: _minekoa$elm_text_editor$Ports_WebStrage$localStrage_setItem(
						{
							...
							_1: A2(
								_elm_lang$core$Json_Encode$encode,
								0,
								_minekoa$elm_text_editor$TextEditor_Style$jsonEncode(newstyle))
						})
				};
			case 'Change_Common_FGColor':
				...
				var newstyle = A2(updateCommonFgColor, _p4, model.style);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							...
							editTarget: A3(
								...
								_minekoa$elm_text_editor$StyleMenu$fgColorList(_p4))
						}),
					_1: _minekoa$elm_text_editor$Ports_WebStrage$localStrage_setItem(
						{
							ctor: '_Tuple2',
			...
			case 'Change_Common_FontFamily':
				...
				var newstyle = A2(updateCommonFtFamily, _p5, model.style);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							...
							editTarget: A3(
								...
								_minekoa$elm_text_editor$StyleMenu$fontFamilyList(_p5))
						}),
					_1: _minekoa$elm_text_editor$Ports_WebStrage$localStrage_setItem(
						{
							ctor: '_Tuple2',
			...
			case 'Change_Common_FontSize':
				...
				var newstyle = A2(updateCommonFtSize, _p6, model.style);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							...
							editTarget: A3(
								...
								_minekoa$elm_text_editor$StyleMenu$fontSizeList(_p6))
						}),
					_1: _minekoa$elm_text_editor$Ports_WebStrage$localStrage_setItem(
						{
							ctor: '_Tuple2',
...
var _minekoa$elm_text_editor$SettingMenu$intOptionSettingControl = F4(
	function (label, tagger, opts, value) {
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('settingmenu-option'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('settingmenu-option-label'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('settingmenu-option-control'),
							_1: {ctor: '[]'}
						},
						A2(
							_elm_lang$core$List$map,
							function (i) {
								return A2(
									_elm_lang$html$Html$div,
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class(
											_elm_lang$core$Native_Utils.eq(value, i) ? 'setting-option-value-active' : 'setting-option-value-disactive'),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(
												tagger(i)),
...
var _minekoa$elm_text_editor$SettingMenu$boolSettingControl = F3(
	function (label, tagger, value) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
						...
						},
						{
							...
							_0: A2(
								_elm_lang$html$Html$div,
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class(
										value ? 'setting-option-value-active' : 'setting-option-value-disactive'),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(
											tagger(!value)),
...
var _minekoa$elm_text_editor$SettingMenu$update = F2(
	function (msg, model) {
					...
					return {
						...
						_0: function (new_opts) {
							...
							A2(
								...
								A2(
									_elm_lang$core$Result$andThen,
									_elm_lang$core$Json_Decode$decodeString(_minekoa$elm_text_editor$TextEditor_Option$jsonDecode),
					...
					_1: _minekoa$elm_text_editor$Ports_WebStrage$localStrage_setItem(
						{
							...
							_1: A2(
								_elm_lang$core$Json_Encode$encode,
								0,
								_minekoa$elm_text_editor$TextEditor_Option$jsonEncode(new_opts))
						})
				};
			case 'ChangeTabOrder':
				var new_opts = _elm_lang$core$Native_Utils.update(
...
var _minekoa$elm_text_editor$SettingMenu$Model = F2(
	function (a, b) {
		return {options: a, selectedSubMenu: b};
	});
...
var _minekoa$elm_text_editor$SettingMenu$ChangeTabOrder = function (a) {
	return {ctor: 'ChangeTabOrder', _0: a};
};
var _minekoa$elm_text_editor$SettingMenu$ChangeShowCtrlChar = function (a) {
	return {ctor: 'ChangeShowCtrlChar', _0: a};
};
var _minekoa$elm_text_editor$SettingMenu$renderingOptionView = function (core_opts) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: A3(_minekoa$elm_text_editor$SettingMenu$boolSettingControl, 'show ctrl charactor', _minekoa$elm_text_editor$SettingMenu$ChangeShowCtrlChar, core_opts.showControlCharactor),
			_1: {
				ctor: '::',
				_0: A4(
					_minekoa$elm_text_editor$SettingMenu$intOptionSettingControl,
					'tab order',
					_minekoa$elm_text_editor$SettingMenu$ChangeTabOrder,
					{
						ctor: '::',
						_0: 2,
						_1: {
				...
				_1: {
					ctor: '::',
					_0: A3(_minekoa$elm_text_editor$SettingMenu$boolSettingControl, 'indent tabs mode', _minekoa$elm_text_editor$SettingMenu$ChangeIndentTabs, core_opts.indentTabsMode),
					_1: {ctor: '[]'}
				}
			}
		});
};
var _minekoa$elm_text_editor$SettingMenu$menuPalette = function (model) {
	var _p1 = model.selectedSubMenu;
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		{
			ctor: '::',
			_0: _minekoa$elm_text_editor$SettingMenu$renderingOptionView(model.options),
			_1: {ctor: '[]'}
		});
};
var _minekoa$elm_text_editor$SettingMenu$SelectSubMenu = function (a) {
	return {ctor: 'SelectSubMenu', _0: a};
};
var _minekoa$elm_text_editor$SettingMenu$menuItemsView = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_0: A2(
				_elm_lang$html$Html$div,
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(
						_minekoa$elm_text_editor$SettingMenu$SelectSubMenu(_minekoa$elm_text_editor$SettingMenu$RenderingOptionMenu)),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class(
							_elm_lang$core$Native_Utils.eq(model.selectedSubMenu, _minekoa$elm_text_editor$SettingMenu$RenderingOptionMenu) ? 'menu-item-active' : 'menu-item'),
						_1: {ctor: '[]'}
					}
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Rendering Options'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}),
...
var _minekoa$elm_text_editor$SettingMenu$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('setting-menu'),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('menu-root'),
				_1: {
		...
		{
			ctor: '::',
			_0: _minekoa$elm_text_editor$SettingMenu$menuItemsView(model),
			_1: {
				ctor: '::',
				...
				function (s) {
					return _elm_lang$core$Maybe$Just(
						A2(
							...
							A2(
								_elm_lang$core$Basics_ops['++'],
								_elm_lang$core$Basics$toString(s.begin.row),
								A2(
									_elm_lang$core$Basics_ops['++'],
									',',
									A2(
										_elm_lang$core$Basics_ops['++'],
										_elm_lang$core$Basics$toString(s.begin.column),
										A2(
											_elm_lang$core$Basics_ops['++'],
											')-(',
											A2(
												_elm_lang$core$Basics_ops['++'],
												_elm_lang$core$Basics$toString(s.end.row),
												A2(
													_elm_lang$core$Basics_ops['++'],
													',',
													A2(
														_elm_lang$core$Basics_ops['++'],
														_elm_lang$core$Basics$toString(s.end.column),
														')')))))))));
				},
				selection));
	};
				...
				function (mk) {
					return _elm_lang$core$Maybe$Just(
						mk.actived ? A2(
							...
							A2(
								_elm_lang$core$Basics_ops['++'],
								_elm_lang$core$Basics$toString(mk.pos.row),
								A2(
									_elm_lang$core$Basics_ops['++'],
									',',
									A2(
										_elm_lang$core$Basics_ops['++'],
										_elm_lang$core$Basics$toString(mk.pos.column),
										')')))) : '');
				},
				mark));
	};
						...
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return function (k) {
											return {editor: a, buffers: b, currentBufferIndex: c, currentBufferName: d, pane: e, $debugger: f, swkeyboard: g, style: h, filer: i, keybindMenu: j, settingMenu: k};
										};
									};
								};
							};
...
var _minekoa$elm_text_editor$Main$SettingMenuPane = {ctor: 'SettingMenuPane'};
...
var _minekoa$elm_text_editor$Main$SettingMenuMsg = function (a) {
	return {ctor: 'SettingMenuMsg', _0: a};
};
			...
			_1: {
				...
				_1: {
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: A2(tab, _minekoa$elm_text_editor$Main$SettingMenuPane, 'Setting'),
							_1: {
								ctor: '::',
			...
			_1: {
				...
				_0: function () {
					...
					switch (_p4.ctor) {
						...
						case 'SettingMenuPane':
							return A2(
								_elm_lang$html$Html$map,
								_minekoa$elm_text_editor$Main$SettingMenuMsg,
								_minekoa$elm_text_editor$SettingMenu$view(model.settingMenu));
						default:
...
var _minekoa$elm_text_editor$Main$init = function () {
	...
	var _p6 = A5(_minekoa$elm_text_editor$TextEditor$init, 'editor-sample1', _minekoa$elm_text_editor$TextEditor_Option$editorLikeOptions, editorStyle, keybinds, content);
	var bm = _p6._0;
	var bc = _p6._1;
