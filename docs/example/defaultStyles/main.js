...
var _minekoa$elm_text_editor$Main$defaultText = 'ABCDEFG HIJKLMN\nOPQRSTU VWXYZ\n\n01234 56789\n\n\tabcdefg hijklmn\n\t\topqrstu vwxyz\n\nあいうえお　かきくけこ\nさしすせそ　たちつてと\nなにぬねの　はひふへほ\nまみむめも　や　ゆ　よ\nらりるれろ　わゐ　ゑを\nん\n';
var _minekoa$elm_text_editor$Main$Model = F3(
	function (a, b, c) {
		return {notepad: a, editor: b, modern: c};
	});
var _minekoa$elm_text_editor$Main$ModernMsg = function (a) {
	return {ctor: 'ModernMsg', _0: a};
};
...
var _minekoa$elm_text_editor$Main$init = function () {
	...
	var m3 = _p0._0;
	var c3 = _p0._1;
	var _p1 = A2(_minekoa$elm_text_editor$TextEditor$initLikeCodeEditor, 'id_editor', _minekoa$elm_text_editor$Main$defaultText);
	var m2 = _p1._0;
	var c2 = _p1._1;
	var _p2 = A2(_minekoa$elm_text_editor$TextEditor$initLikeNotepad, 'id_notepad', _minekoa$elm_text_editor$Main$defaultText);
	var m1 = _p2._0;
	var c1 = _p2._1;
	return {
		ctor: '_Tuple2',
		_0: A3(_minekoa$elm_text_editor$Main$Model, m1, m2, m3),
		_1: _elm_lang$core$Platform_Cmd$batch(
			{
				ctor: '::',
...
var _minekoa$elm_text_editor$Main$update = F2(
	function (msg, model) {
		...
		switch (_p3.ctor) {
			case 'NotepadMsg':
				var _p4 = A2(_minekoa$elm_text_editor$TextEditor$update, _p3._0, model.notepad);
				var m = _p4._0;
				var c = _p4._1;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{notepad: m}),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _minekoa$elm_text_editor$Main$NotepadMsg, c)
				};
			case 'EditorMsg':
				var _p5 = A2(_minekoa$elm_text_editor$TextEditor$update, _p3._0, model.editor);
				var m = _p5._0;
				var c = _p5._1;
				return {
					ctor: '_Tuple2',
			...
			default:
				var _p6 = A2(_minekoa$elm_text_editor$TextEditor$update, _p3._0, model.modern);
				var m = _p6._0;
				var c = _p6._1;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{modern: m}),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _minekoa$elm_text_editor$Main$ModernMsg, c)
				};
		}
	});
	...
	return _elm_lang$core$Platform_Sub$batch(
		{
			...
			_0: A2(
				_elm_lang$core$Platform_Sub$map,
				_minekoa$elm_text_editor$Main$NotepadMsg,
				_minekoa$elm_text_editor$TextEditor$subscriptions(model.notepad)),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$core$Platform_Sub$map,
				...
				_1: {
					...
					_0: A2(
						_elm_lang$core$Platform_Sub$map,
						_minekoa$elm_text_editor$Main$ModernMsg,
						_minekoa$elm_text_editor$TextEditor$subscriptions(model.modern)),
					_1: {ctor: '[]'}
				}
			}
		});
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('defaultStyles'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$href('https://github.com/minekoa/elm-text-editor/tree/master/example/defaultStyles'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
				...
				_1: {
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('More examples'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{ctor: '[]'},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('TextEditor.initLikeNotepad'),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}),
								...
								_0: A2(
										...
										_0: _elm_lang$html$Html_Attributes$style(
											{
												...
												_1: {
													...
													_1: {
														ctor: '::',
														_0: {ctor: '_Tuple2', _0: 'margin', _1: '0.5em 1em'},
														_1: {ctor: '[]'}
													}
												}
											}),
									...
									},
									{
										...
										_0: A2(
											...
											_minekoa$elm_text_editor$Main$NotepadMsg,
											_minekoa$elm_text_editor$TextEditor$view(model.notepad)),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{ctor: '[]'},
										{
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('TextEditor.initLikeCodeEditor'),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}),
											...
											_0: A2(
												...
												{ctor: '[]'},
												{
													...
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html$text('TextEditor.initLikeModernEditor'),
															_1: {ctor: '[]'}
														}),
													_1: {ctor: '[]'}
												}),
												...
												_0: A2(
													...
													},
													{
														...
														_0: A2(
															_elm_lang$html$Html$map,
															_minekoa$elm_text_editor$Main$ModernMsg,
															_minekoa$elm_text_editor$TextEditor$view(model.modern)),
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
											}
