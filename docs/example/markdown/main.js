...
var _minekoa$elm_text_editor$Main$init = function () {
	...
	return {
		...
		_0: A2(
			...
			m,
			_minekoa$elm_text_editor$TextEditor$buffer(m).contents),
...
var _minekoa$elm_text_editor$Main$update = F2(
	function (msg, model) {
		var _p1 = msg;
		var _p4 = _p1._0;
		var _p2 = A2(_minekoa$elm_text_editor$TextEditor$update, _p4, model.editor);
		var m = _p2._0;
		var c = _p2._1;
		var _p3 = _p4;
		if (_p3.ctor === 'UpdateContents') {
			return {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{editor: m, contents: _p3._0}),
				_1: A2(_elm_lang$core$Platform_Cmd$map, _minekoa$elm_text_editor$Main$EditorMsg, c)
			};
		} else {
			return {
				...
				_0: A2(
					...
					},
					{
						...
						_0: A3(
							...
							_minekoa$elm_text_editor$Main$markdownOptions,
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('md'),
								_1: {ctor: '[]'}
							},
