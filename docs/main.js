...
var _minekoa$elm_text_editor$TextEditor_Buffer$insert_proc = F3(
	function (_p25, text, model) {
		var _p26 = _p25;
		var _p31 = _p26._0;
		var _p30 = _p26._1;
		var car = function (_p27) {
			return A2(
				_elm_lang$core$Maybe$withDefault,
				'',
		...
		var crow = A2(
			_elm_lang$core$Maybe$withDefault,
			'',
			A2(_minekoa$elm_text_editor$TextEditor_Buffer$line, _p31, model.contents));
		var left = A2(_elm_lang$core$String$left, _p30, crow);
		var right = A2(_elm_lang$core$String$dropLeft, _p30, crow);
		var contents = model.contents;
		var prows = A2(_elm_lang$core$List$take, _p31, contents);
		var nrows = A2(_elm_lang$core$List$drop, _p31 + 1, contents);
		var _p28 = _elm_lang$core$List$length(texts);
		switch (_p28) {
			case 0:
				return model;
			case 1:
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						...
						cursor: A2(
							_minekoa$elm_text_editor$TextEditor_Buffer$Cursor,
							_p31,
							_p30 + _elm_lang$core$String$length(text))
					});
			case 2:
				var lst_ln = car(
			...
			default:
				var _p29 = _p28;
				var lst_ln = car(
					A2(_elm_lang$core$List$drop, _p29 - 1, texts));
				var fst_ln = car(texts);
				return _elm_lang$core$Native_Utils.update(
					model,
					{
							...
							A2(
								...
								A2(
									...
									A2(
										_elm_lang$core$List$drop,
										1,
										A2(_elm_lang$core$List$take, _p29 - 1, texts)),
									A2(
										_elm_lang$core$Basics_ops['++'],
										{
											ctor: '::',
...
var _minekoa$elm_text_editor$TextEditor_Buffer$backspace_proc = F2(
	function (_p36, model) {
		...
		var _p40 = _p37._0;
		var _p39 = _p37._1;
		var _p38 = {ctor: '_Tuple2', _0: _p40, _1: _p39};
		if (_p38._1 === 0) {
			if (_p38._0 === 0) {
				...
				var n_col = _elm_lang$core$String$length(
					A2(
						...
						'',
						_elm_lang$core$List$head(
							A2(_elm_lang$core$List$drop, _p40 - 1, model.contents))));
				var nrows = A2(_elm_lang$core$List$drop, _p40 + 1, model.contents);
				var crow = _elm_lang$core$String$concat(
					A2(
						_elm_lang$core$List$take,
						2,
						A2(_elm_lang$core$List$drop, _p40 - 1, model.contents)));
				var prows = A2(_elm_lang$core$List$take, _p40 - 1, model.contents);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							...
							cursor: A2(_minekoa$elm_text_editor$TextEditor_Buffer$Cursor, _p40 - 1, n_col)
						}),
			...
			var crow = A2(
				_elm_lang$core$Maybe$withDefault,
				'',
				A2(_minekoa$elm_text_editor$TextEditor_Buffer$line, _p40, model.contents));
			var left = A2(_elm_lang$core$String$left, _p39 - 1, crow);
			var right = A2(_elm_lang$core$String$dropLeft, _p39, crow);
			var prows = A2(_elm_lang$core$List$take, _p40, model.contents);
			return {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{
						...
						cursor: A2(_minekoa$elm_text_editor$TextEditor_Buffer$Cursor, _p40, _p39 - 1)
					}),
				_1: _elm_lang$core$Maybe$Just(
					A2(
						_elm_lang$core$String$left,
						1,
						A2(_elm_lang$core$String$dropLeft, _p39 - 1, crow)))
			};
		}
	});
var _minekoa$elm_text_editor$TextEditor_Buffer$delete_proc = F2(
	function (_p41, model) {
		...
		var ln = A2(
			_elm_lang$core$Maybe$withDefault,
			'',
			A2(_minekoa$elm_text_editor$TextEditor_Buffer$line, _p45, model.contents));
		var max_col = _minekoa$elm_text_editor$TextEditor_Buffer$maxColumn(ln);
		var _p43 = {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Native_Utils.eq(_p45, max_row),
			_1: _elm_lang$core$Native_Utils.cmp(_p44, max_col) > 0
		};
		if (_p43._1 === false) {
			var current = A2(
				_elm_lang$core$Basics_ops['++'],
				A2(_elm_lang$core$String$left, _p44, ln),
				A2(_elm_lang$core$String$dropLeft, _p44 + 1, ln));
			var nrows = A2(_elm_lang$core$List$drop, _p45 + 1, model.contents);
			var prows = A2(_elm_lang$core$List$take, _p45, model.contents);
			return {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{
						...
						cursor: A2(_minekoa$elm_text_editor$TextEditor_Buffer$Cursor, _p45, _p44)
					}),
				_1: _elm_lang$core$Maybe$Just(
					A2(
						_elm_lang$core$String$left,
						1,
						A2(_elm_lang$core$String$dropLeft, _p44, ln)))
			};
		} else {
			if (_p43._0 === true) {
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Maybe$Nothing};
			} else {
				var nrows = A2(_elm_lang$core$List$drop, _p45 + 2, model.contents);
				var nxt = A2(
					_elm_lang$core$Maybe$withDefault,
					'',
					A2(_minekoa$elm_text_editor$TextEditor_Buffer$line, _p45 + 1, model.contents));
	...
	function (_p48, _p47, str, model) {
		...
		return function (m) {
			return _elm_lang$core$Native_Utils.update(
				m,
				{
					cursor: A2(_minekoa$elm_text_editor$TextEditor_Buffer$Cursor, _p52, _p51)
				});
		}(
			A3(
				_minekoa$elm_text_editor$TextEditor_Buffer$insert_proc,
				{ctor: '_Tuple2', _0: _p52, _1: _p51},
				str,
				model));
	});
...
var _minekoa$elm_text_editor$TextEditor_Buffer$moveForward = function (model) {
	var _p53 = _minekoa$elm_text_editor$TextEditor_Buffer$isMarkActive(model);
	if (_p53 === true) {
...
var _minekoa$elm_text_editor$TextEditor_Buffer$moveAt = F2(
	function (_p57, model) {
		...
		var _p61 = _p58._0;
		var _p60 = _p58._1;
		var _p59 = _minekoa$elm_text_editor$TextEditor_Buffer$isMarkActive(model);
		if (_p59 === true) {
			return A2(
...
var _minekoa$elm_text_editor$TextEditor_Buffer$selectBackward = function (_p63) {
	return A2(
		_minekoa$elm_text_editor$TextEditor_Buffer$selectWithMove,
...
var _minekoa$elm_text_editor$TextEditor_Buffer$selectForward = function (_p64) {
	return A2(
		_minekoa$elm_text_editor$TextEditor_Buffer$selectWithMove,
...
var _minekoa$elm_text_editor$TextEditor_Buffer$selectPrevios = function (_p65) {
	return A2(
		_minekoa$elm_text_editor$TextEditor_Buffer$selectWithMove,
...
var _minekoa$elm_text_editor$TextEditor_Buffer$selectNext = function (_p66) {
	return A2(
		_minekoa$elm_text_editor$TextEditor_Buffer$selectWithMove,
				...
				switch (_p73.ctor) {
					case 'Cmd_Insert':
						return function (m) {
							...
							A4(_minekoa$elm_text_editor$TextEditor_Buffer$undo_insert_proc, _p73._0, _p73._1, _p73._2, model));
					case 'Cmd_Backspace':
						return function (m) {
							return _elm_lang$core$Native_Utils.update(
								m,
							...
							A4(_minekoa$elm_text_editor$TextEditor_Buffer$undo_backspace_proc, _p73._0, _p73._1, _p73._2, model));
					default:
						return function (m) {
							return _elm_lang$core$Native_Utils.update(
								m,
							...
							A4(_minekoa$elm_text_editor$TextEditor_Buffer$undo_delete_proc, _p73._0, _p73._1, _p73._2, model));
				}
			}());
	}
};
...
var _minekoa$elm_text_editor$TextEditor_Buffer$appendHistory = F2(
	function (cmd, model) {
		...
		_v33_3:
		do {
			if (_p74._1.ctor === 'Just') {
				switch (_p74._0.ctor) {
					case 'Cmd_Insert':
						if (_p74._1._0.ctor === 'Cmd_Insert') {
							var _p76 = _p74._1._0._0;
							var _p75 = _p74._0._0;
							return (_elm_lang$core$Native_Utils.eq(
								row(_p75),
								row(_p76)) && _elm_lang$core$Native_Utils.eq(
								col(_p75),
								col(_p74._1._0._1))) ? _elm_lang$core$Native_Utils.update(
								model,
								{
									history: {
										ctor: '::',
										_0: A4(
											...
											_p76,
											_p74._0._1,
											A2(_elm_lang$core$Basics_ops['++'], _p74._1._0._2, _p74._0._2),
											_p74._1._0._3),
					...
					case 'Cmd_Backspace':
						if (_p74._1._0.ctor === 'Cmd_Backspace') {
							var _p78 = _p74._1._0._0;
							var _p77 = _p74._0._0;
							return (_elm_lang$core$Native_Utils.eq(
								row(_p77),
								...
								model,
								{
									history: {
										...
										_0: A4(
											...
											_p78,
											_p74._0._1,
											A2(_elm_lang$core$Basics_ops['++'], _p74._0._2, _p74._1._0._2),
											_p74._1._0._3),
										_1: A2(_elm_lang$core$List$drop, 1, model.history)
									}
								}) : _elm_lang$core$Native_Utils.update(
					...
					default:
						if (_p74._1._0.ctor === 'Cmd_Delete') {
							var _p80 = _p74._1._0._0;
							var _p79 = _p74._0._0;
							return (_elm_lang$core$Native_Utils.eq(
								row(_p79),
								row(_p80)) && _elm_lang$core$Native_Utils.eq(
								col(_p79),
								col(_p80))) ? _elm_lang$core$Native_Utils.update(
								model,
								{
									history: {
										ctor: '::',
...
var _minekoa$elm_text_editor$TextEditor_Buffer$backspace = function (model) {
	...
	if (_p94.ctor === 'Nothing') {
		...
		return _minekoa$elm_text_editor$TextEditor_Buffer$selectionClear(
			A2(_minekoa$elm_text_editor$TextEditor_Buffer$deleteRange, _p94._0, model));
	}
};
var _minekoa$elm_text_editor$TextEditor_Buffer$delete = function (model) {
	var _p95 = model.selection;
	if (_p95.ctor === 'Nothing') {
		...
		return _minekoa$elm_text_editor$TextEditor_Buffer$selectionClear(
			A2(_minekoa$elm_text_editor$TextEditor_Buffer$deleteRange, _p95._0, model));
	}
};
...
var _minekoa$elm_text_editor$TextEditor$logging = F3(
	function (ev_name, ev_data, _p12) {
		var _p13 = _p12;
		var _p16 = _p13._0;
		var _p15 = _p13._1;
		var _p14 = _p16.event_log;
		if (_p14.ctor === 'Just') {
			return {
				ctor: '_Tuple2',
				_0: _p16,
...
var _minekoa$elm_text_editor$TextEditor$init = F3(
	function (id, keymap, text) {
		var _p17 = A2(_minekoa$elm_text_editor$TextEditor_Core$init, id, text);
		var coreM = _p17._0;
		var coreC = _p17._1;
		return {
			ctor: '_Tuple2',
...
var _minekoa$elm_text_editor$KeyBindMenu$insertValueMessage = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
...
var _minekoa$elm_text_editor$KeyBindMenu$keypressMessage = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
...
var _minekoa$elm_text_editor$KeyBindMenu$Model = F4(
	function (a, b, c, d) {
		return {selectedSubMenu: a, mainsPage: b, currentIdx: c, current: d};
	});
var _minekoa$elm_text_editor$KeyBindMenu$EditBuffer = F3(
	function (a, b, c) {
		return {keybind: a, target: b, insertS: c};
	});
...
var _minekoa$elm_text_editor$KeyBindMenu$initEditBuffer = function (kbind) {
	...
	return {keybind: kbind, target: _minekoa$elm_text_editor$KeyBindMenu$TargetNone, insertS: s};
};
...
var _minekoa$elm_text_editor$KeyBindMenu$commandListView = function (model) {
	var cmdlist = {
		ctor: '::',
		...
		switch (_p4.ctor) {
					...
					_1: _elm_lang$core$Native_Utils.update(
						model,
						{
							...
							current: A2(
								...
								function (_p5) {
									return _elm_lang$core$Maybe$Just(
										_minekoa$elm_text_editor$KeyBindMenu$initEditBuffer(_p5));
								},
								_elm_lang$core$List$head(
			...
			case 'KeyDown':
				...
				if (_p7.ctor === 'Just') {
					var _p9 = _p7._0;
					var _p8 = _p9.target;
					if (_p8.ctor === 'TargetKeys') {
						var kbind = _p9.keybind;
						var new_kbind = _elm_lang$core$Native_Utils.update(
							kbind,
							{ctrl: _p10.ctrlKey, alt: _p10.altKey, shift: _p10.shiftKey, code: _p10.keyCode});
						return {
							ctor: '_Tuple3',
							_0: keybinds,
							_1: _elm_lang$core$Native_Utils.update(
			...
			case 'InputText':
				...
				if (_p11.ctor === 'Just') {
					...
					if (_p12.ctor === 'TargetInsertValue') {
						var kbind = _p13.keybind;
						var new_kbind = _elm_lang$core$Native_Utils.update(
							kbind,
							{
								f: _minekoa$elm_text_editor$TextEditor_Commands$insert(_p14)
							});
						return {
							ctor: '_Tuple3',
							_0: keybinds,
								...
								model,
								{
									current: _elm_lang$core$Maybe$Just(
										_elm_lang$core$Native_Utils.update(
											...
											{
												keybind: new_kbind,
												insertS: _elm_lang$core$Maybe$Just(_p14)
											}))
								}),
							_2: _elm_lang$core$Platform_Cmd$none
						};
									...
									var sval = _elm_lang$core$Native_Utils.eq(
										...
										A2(
											...
											A3(
												...
												1,
												_elm_lang$core$String$length('insert')),
											_p17.id)) : _elm_lang$core$Maybe$Nothing;
								...
								_1: {
									...
									_0: A2(
										...
										},
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text(
												_minekoa$elm_text_editor$KeyBindMenu$keyCodeToKeyName(edtbuf.keybind.code)),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
			...
			},
			{
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: A2(_minekoa$elm_text_editor$KeyBindMenu$currentKeybindView, edtbuf, model),
							_1: {
								ctor: '::',
								_0: A2(
									_elm_lang$html$Html$textarea,
									{
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: _minekoa$elm_text_editor$KeyBindMenu$onKeyDown(_minekoa$elm_text_editor$KeyBindMenu$KeyDown),
												_1: {
													ctor: '::',
								...
								_1: {
									ctor: '::',
									_0: function () {
										var _p18 = edtbuf.target;
										switch (_p18.ctor) {
											case 'TargetKeys':
												return _minekoa$elm_text_editor$KeyBindMenu$keypressMessage(model);
											case 'TargetCommand':
												return _minekoa$elm_text_editor$KeyBindMenu$commandListView(model);
											case 'TargetInsertValue':
												return _minekoa$elm_text_editor$KeyBindMenu$insertValueMessage(model);
											default:
												return A2(
													_elm_lang$html$Html$div,
													{ctor: '[]'},
								...
								_1: {
											...
											_1: {
												...
												_0: A2(
													...
													},
													{
														ctor: '::',
														_0: function () {
															var _p20 = model.current;
															if (_p20.ctor === 'Just') {
																return _elm_lang$html$Html$text(
																	kbind2str(_p20._0.keybind));
															} else {
																return _elm_lang$html$Html$text('');
															}
														}(),
									...
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Are you sure you want to update this keybind?'),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
...
var _minekoa$elm_text_editor$KeyBindMenu$menuPalette = F2(
	function (keybinds, model) {
		var _p21 = model.selectedSubMenu;
		if (_p21.ctor === 'KeybindMain') {
			var _p22 = model.mainsPage;
			switch (_p22.ctor) {
				case 'ListPage':
					return A2(
						_elm_lang$html$Html$div,
				...
				case 'EditPage':
					...
					if (_p23.ctor === 'Just') {
						return A2(
							...
							{
								ctor: '::',
								_0: A2(_minekoa$elm_text_editor$KeyBindMenu$editPageView, _p23._0, model),
								_1: {ctor: '[]'}
							});
					} else {
						return A2(
			...
			_0: A2(
				_elm_lang$html$Html$div,
				{
					...
					_1: {
						...
						_0: _elm_lang$html$Html_Attributes$class(
							function () {
								var _p24 = model.selectedSubMenu;
								if (_p24.ctor === 'KeybindMain') {
...
var _minekoa$elm_text_editor$Main$init = function () {
	var _p5 = _minekoa$elm_text_editor$StyleMenu$init;
	var smm = _p5._0;
	var smc = _p5._1;
	var content = '';
		...
		_0: _minekoa$elm_text_editor$Main$Model(bm)(
			{
				...
				_0: buf,
				_1: {ctor: '[]'}
			})(0)(buf.name)(_minekoa$elm_text_editor$Main$NoPane)(_minekoa$elm_text_editor$DebugMenu$init)(_minekoa$elm_text_editor$SoftwareKeyboard$init)(smm)(_minekoa$elm_text_editor$FileMenu$init)(_minekoa$elm_text_editor$KeyBindMenu$init),
		_1: _elm_lang$core$Platform_Cmd$batch(
			{
				ctor: '::',
	...
	function (model, _p7) {
		...
		return {
			...
			_0: _elm_lang$core$Native_Utils.update(
				model,
				{editor: _p8._0}),
			_1: A2(_elm_lang$core$Platform_Cmd$map, _minekoa$elm_text_editor$Main$EditorMsg, _p8._1)
		};
	});
		...
		switch (_p9.ctor) {
			...
			case 'CloseBuffer':
				...
				return {
					ctor: '_Tuple2',
					_0: function (m) {
						return _elm_lang$core$Native_Utils.eq(_p10, m.currentBufferIndex) ? A2(_minekoa$elm_text_editor$Main$selectBuffer, _p10, m) : ((_elm_lang$core$Native_Utils.cmp(_p10, m.currentBufferIndex) < 0) ? _elm_lang$core$Native_Utils.update(
							m,
							{currentBufferIndex: m.currentBufferIndex - 1}) : m);
					}(
						A2(_minekoa$elm_text_editor$Main$removeBuffer, _p10, model)),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'ChangePane':
				return {
			...
			case 'EditorMsg':
				var _p11 = A2(_minekoa$elm_text_editor$TextEditor$update, _p9._0, model.editor);
				var m = _p11._0;
				var c = _p11._1;
				return {
					ctor: '_Tuple2',
			...
			case 'DebugMenuMsg':
				var _p12 = A3(_minekoa$elm_text_editor$DebugMenu$update, _p9._0, model.editor, model.$debugger);
				var em = _p12._0;
				var dm = _p12._1;
				var dc = _p12._2;
				return {
			...
			case 'KeyBindMenuMsg':
				var _p20 = A3(_minekoa$elm_text_editor$KeyBindMenu$update, _p9._0, model.editor.keymap, model.keybindMenu);
				var kbinds = _p20._0;
				var km = _p20._1;
				var kc = _p20._2;
				var em = model.editor;
